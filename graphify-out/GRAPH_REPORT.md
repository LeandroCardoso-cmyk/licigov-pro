...
## Corpus Check
- 1922 files · ~2,536,792 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 14370 nodes · 27350 edges · 1126 communities (698 shown, 428 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 67 edges (avg confidence: 0.72)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ceac7126`
...
## Communities (1126 total, 428 thin omitted)

### Community 0 - "schema.ts"
Cohesion: 0.01
Nodes (369): actionSafetyLogsTable, ActivityLog, agentExecutionsTable, AIExecutionAuditRow, aiExecutionAuditsTable, AIOrchestrationRow, aiOrchestrationsTable, AIPromptVersionRow (+361 more)

### Community 1 - "card.tsx"
Cohesion: 0.02
Nodes (182): AdminStatsGrid(), Props, StatCardProps, AdminUser, AdminUsersTable(), Props, ChecklistPreviewDialogWrapper(), Props (+174 more)

### Community 2 - "trpc.ts"
Cohesion: 0.02
Nodes (158): activityLogs, documentAttachments, documentDrafts, documents, documentTimeline, calculateBackoffMs(), isRetryable(), RetryPolicy (+150 more)

### Community 3 - "getDb"
Cohesion: 0.02
Nodes (196): auditLogs, catmatSuggestions, comments, companyDocuments, contractRenewals, DocumentSettings, documentTemplates, editalParameters (+188 more)
...
Cohesion: 0.07
Nodes (46): getEvidenceByField(), hasHumanOverride(), buildReviewTransition(), canAutoAdvance(), currentStateFromHistory(), guardReviewTransition(), ImportReviewTransition, isHumanActionRequired() (+38 more)

### Community 7 - "cn"
Cohesion: 0.02
Nodes (234): AIChatBox(), AIChatBoxProps, Message, DashboardLayout(), DashboardLayoutContent(), DashboardLayoutContentProps, menuItems, THEME_OPTIONS (+226 more)
...
Cohesion: 0.06
Nodes (90): Props, Props, Props, CandidateDecisionModalProps, CandidateInfo, AddStepDialog(), Props, ChecklistStep (+82 more)
...
Cohesion: 0.08
Nodes (45): ALL_LEGAL_CONCEPT_IDS, conceptsByCategory(), getLegalConcept(), isLegalConcept(), LEGAL_CONCEPTS, LegalConcept, LegalConceptCategory, LegalConceptId (+37 more)

### Community 15 - "sprint32-production-hardening.test.ts"
Cohesion: 0.04
Nodes (60): lastIngestionJobs, productionReadinessRouter, CatalogEntryType, ingestCatalog(), normalizeCatalogEntry(), CacheConfig, CacheEntry, CacheMetrics (+52 more)
...
Cohesion: 0.04
Nodes (62): Process, adminProcedure, ORG_ROLE_RANK, protectedProcedure, requireUser, resolveTenant, t, activitiesRouter (+54 more)
...
Cohesion: 0.07
Nodes (59): createKnowledgeBase(), KnowledgeBase, structuralSampleBase(), conflictId(), ConflictResolutionStrategy, ConflictSeverity, ConflictType, detectConflicts() (+51 more)

### Community 21 - "sprint48-knowledge-graph.test.ts"
Cohesion: 0.04
Nodes (86): assessClauseRisk(), ClauseCategory, ClauseKnowledgeItem, ClauseRiskLevel, createClauseKnowledge(), buildSimilarityMetadata(), computeSimilarity(), createEntityResolution() (+78 more)
...
Cohesion: 0.04
Nodes (45): Auto-save no Editor, Backend (Implementado), Colaboração em Processos, Configurações de Cabeçalho e Rodapé, Correção de Bugs Críticos, Correções de TypeScript Realizadas, Correções e Melhorias Recentes, CRUD de Checklists (+37 more)
...
### Community 29 - "react"
Cohesion: 0.08
Nodes (36): copilotDecisionTracesTable, copilotMetricsTable, copilotPoliciesTable, copilotRecommendationsTable, copilotSessionsTable, copilotsTable, tenantProcedure, getCopilotPolicy() (+28 more)
...
Cohesion: 0.06
Nodes (59): EmbeddingCache, lawChunks, @google/generative-ai, @google/generative-ai, shouldDisableThinking(), ALLOWED_MIME_TYPES, log, chunkSize (+51 more)
...
Cohesion: 0.01
Nodes (141): AiAssistantPanel(), Props, Result, Tab, TAB_CONFIG, AuditTimeline(), BusinessDomainCode, DomainWorkspaceLauncherProps (+133 more)
...
Cohesion: 0.07
Nodes (32): ActionList(), CopilotPolicyManager(), COPILOTS, RISK_OPTIONS, RiskThreshold, RESPONSE_STATUSES, RESPONSE_TYPES, ResponsePanel() (+24 more)
...
Cohesion: 0.09
Nodes (29): organizations, bootstrap(), ensureSchema(), log(), MIGRATIONS_FOLDER, runMigrations(), seedAdmin(), seedDefaultOrgMembership() (+21 more)

### Community 60 - "sprint34-pilot-readiness.test.ts"
Cohesion: 0.29
Nodes (6): _byCorrelation, clearCorpusEvents(), CorpusEvent, CorpusEventType, getCorpusEvents(), recordCorpusEvent()
...
Cohesion: 0.16
Nodes (15): ContractDocumentsTab(), Props, ContractHistoryTab(), Props, AuditLog, ContractData, ContractDocument, NewAmendmentModal() (+7 more)

### Community 66 - "VersionHistoryDialog.tsx"
Cohesion: 0.04
Nodes (114): contractJustificationsTable, directProcurementProceduresTable, directProcurementWorkspacesTable, generatedPublicationsTable, priceJustificationsTable, proposalCollectionsTable, proposalDocumentsTable, ratificationsTable (+106 more)
...
Cohesion: 0.09
Nodes (48): appendTraceStep(), computeReplaySnapshot(), CopilotDecisionTrace, createCopilotDecisionTrace(), TraceStep, TraceStepType, verifyReplay(), CopilotPolicy (+40 more)
...
Cohesion: 0.11
Nodes (33): ALL_OBJECT_IDS, DOC_STATES, getInstitutionalObject(), INSTITUTIONAL_OBJECTS, InstitutionalObjectId, ObjectCategory, CANONICAL_DEPENDENCY_CHAIN, getDependents() (+25 more)
...
Cohesion: 0.15
Nodes (21): getLicensedModule(), listLicensedModules(), setModuleActive(), upsertLicensedModule(), createLicensedModule(), deactivateModule(), hasFeature(), isExpired() (+13 more)

### Community 89 - "legalReasoningEngine.ts"
Cohesion: 0.14
Nodes (19): INSTITUTIONAL_EVENTS, InstitutionalEvent, InstitutionalEventId, isInstitutionalEvent(), InstitutionalObject, InstitutionalRoleId, ALL_SCENARIO_IDS, CORE_ROLES (+11 more)

### Community 90 - "catalogSearchEngine.ts"
Cohesion: 0.11
Nodes (32): listContractWorkspaces(), listOperationalEvents(), listOperationalTimeline(), listOperationRecords(), listDirectProcurementWorkspaces(), listPendingForDomain(), listLegalOpinionWorkspaces(), listProcesses() (+24 more)
...
Cohesion: 0.09
Nodes (39): Citation, computeReplayHash(), ContextDocument, ContextExplainabilityEntry, ContextPackage, createContextPackage(), CreateContextPackageParams, RetrievedPassage (+31 more)
...
Cohesion: 0.05
Nodes (94): generatedDocumentsTable, intelligentItemsTable, itemCatmatMatchesTable, itemHistoryTable, itemRecommendationsTable, itemRisksTable, priceResearchItemsTable, priceResearchTable (+86 more)
...
Cohesion: 0.04
Nodes (109): ALL_BLOCK_KINDS, blockFingerprint(), createBlock(), CreateBlockParams, createFragment(), KnowledgeBlock, KnowledgeFragment, computeDocumentLineage() (+101 more)
...
Cohesion: 0.06
Nodes (17): queryClient, trpcClient, User, getSessionCookieOptions(), isSecureRequest(), LOCAL_HOSTS, isNonEmptyString(), sdk (+9 more)
...
Cohesion: 0.21
Nodes (25): ALL_EVENT_IDS, isInstitutionalObject(), detectCycle(), eventRefValid(), FINAL_STATES, objectRefValid(), OntologyValidationReport, reachableStates() (+17 more)
...
Cohesion: 0.19
Nodes (16): importSessions, ALLOWED_MIME_TYPES, canRetry(), detectParserType(), IMPORT_TRANSITIONS, ImportSessionStatus, ImportType, isTerminalStatus() (+8 more)
...
Cohesion: 0.20
Nodes (13): express, express, createContext(), TrpcContext, findAvailablePort(), isPortAvailable(), main(), startServer() (+5 more)

### Community 120 - "sprint51-procurement.test.ts"
Cohesion: 0.20
Nodes (15): AI_EXECUTION_POLICIES, AIExecutionPolicy, AITaskId, ALL_AI_TASKS, getExecutionPolicy(), isProviderImplemented(), mockProvider(), resolveProviderByName() (+7 more)
...
Cohesion: 0.24
Nodes (10): ExtractionSummary, ImportError, ImportWarning, noopObservability, ParseOptions, ParserCapabilities, ParseResult, ParserObservability (+2 more)
...
Cohesion: 0.21
Nodes (4): BaseParser, CsvParser, ParserRegistry, XlsxParser
...
Cohesion: 0.10
Nodes (21): Comment, Props, TaskComments(), PRIORITY_COLORS, PRIORITY_LABELS, STATUS_COLORS, STATUS_LABELS, Task (+13 more)
...
Cohesion: 0.12
Nodes (24): aggregateConfidence(), buildFieldConfidence(), scoreToLevel(), withConflict(), createRawItem(), buildProvenance(), DESCRIPTION_PATTERNS, detectDelimiter() (+16 more)
...
Cohesion: 0.02
Nodes (85): App(), AuthenticatedRoute(), ContratosWorkspaceShellRoute, DirectProcurementShellRoute, OperationsHomeShellRoute, ParecerJuridicoShellRoute, ProcessosShellRoute, TirarDuvidasShellRoute (+77 more)
...
Cohesion: 0.10
Nodes (23): ProviderName, GeminiProvider, mapFinishReason(), SAFETY_SETTINGS, MockAIProvider, sha256(), ClaudeProvider, OpenAIProvider (+15 more)
...
Cohesion: 0.21
Nodes (13): ConfidenceLevel, ConfidenceMetadata, EMPTY_CONFIDENCE, ExtractionError, ExtractionErrorCode, ExtractionWarning, ExtractionWarningCode, FieldConfidence (+5 more)
...
Cohesion: 0.12
Nodes (41): code(), getDomainWorkspace(), insertDomainWorkspace(), upsertBusinessDomain(), upsertKernelService(), upsertModuleDependency(), ALL_BUSINESS_DOMAIN_CODES, BASE_KERNEL (+33 more)
...
Cohesion: 0.08
Nodes (62): CorpusExplanation, explainCorpus(), CorpusFramework, createCorpusFramework(), structuralSampleFramework(), buildCorpusHierarchy(), CorpusHierarchy, CorpusHierarchyNode (+54 more)
...
Cohesion: 0.40
Nodes (4): CellLocation, ExtractionLineage, formatLocation(), TransformationRecord
...
Cohesion: 0.22
Nodes (16): insertGeneratedDocument(), listIntelligentItems(), recordProcessEvent(), approveDocument(), createGeneratedDocument(), defaultPresencialJustification(), DocumentKind, DocumentStatus (+8 more)
...
Cohesion: 0.17
Nodes (18): cognitiveObservabilityTable, environmentDiagnostic(), ALL_PROVIDER_NAMES, PROVIDER_ADAPTERS, countObservabilityForTenant(), getObservabilityByCorrelation(), insertObservability(), ObservabilityRow (+10 more)
...
Cohesion: 0.10
Nodes (37): checkDb(), checkEnv(), checkS3(), REQUIRED_ENV_KEYS, systemRouter, clearHealthCheckRuns(), cognitiveModules(), computeHealthScore() (+29 more)
...
Cohesion: 0.07
Nodes (72): ReviewActor, appendItemReviewTransition(), assertOverrideJustification(), buildItemReviewTransition(), currentItemStateFromHistory(), guardItemReviewTransition(), isTerminalItemReviewState(), isValidItemReviewTransition() (+64 more)
...
## Knowledge Gaps
- **6050 isolated node(s):** `OperationsHomeShellRoute`, `ProcessosShellRoute`, `DirectProcurementShellRoute`, `ParecerJuridicoShellRoute`, `ContratosWorkspaceShellRoute` (+6045 more)
...
- **Should `schema.ts` be split into smaller, more focused modules?**
  _Cohesion score 0.005418439716312057 - nodes in this community are weakly interconnected._
- **Should `card.tsx` be split into smaller, more focused modules?**
  _Cohesion score 0.01897264199318312 - nodes in this community are weakly interconnected._
- **Should `trpc.ts` be split into smaller, more focused modules?**
  _Cohesion score 0.023396596858638742 - nodes in this community are weakly interconnected._