...
## Corpus Check
- 1991 files · ~2,593,780 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 14849 nodes · 28653 edges · 1138 communities (709 shown, 429 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 72 edges (avg confidence: 0.72)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f06b376a`
...
4. `Button()` - 132 edges
5. `Card()` - 101 edges
6. `CardContent()` - 99 edges
7. `CardHeader()` - 84 edges
8. `CardTitle()` - 83 edges
9. `Badge()` - 80 edges
...
## Communities (1138 total, 429 thin omitted)

### Community 0 - "schema.ts"
Cohesion: 0.01
Nodes (372): actionSafetyLogsTable, ActivityLog, agentExecutionsTable, AIExecutionAuditRow, aiExecutionAuditsTable, AIOrchestrationRow, aiOrchestrationsTable, AIPromptVersionRow (+364 more)

### Community 1 - "card.tsx"
Cohesion: 0.02
Nodes (168): ActivityFiltersCard(), ACTION_COLORS, ACTION_LABELS, Activity, ActivityLogCard(), Props, AdminStatsGrid(), Props (+160 more)
...
### Community 3 - "getDb"
Cohesion: 0.02
Nodes (169): auditLogs, comments, companyDocuments, contractRenewals, DocumentSettings, documentTemplates, editalParameters, importStagingItems (+161 more)
...
Cohesion: 0.05
Nodes (101): Props, Props, Props, AuditTimelineProps, CandidateDecisionModalProps, CandidateInfo, CatmatSuggestionsModalProps, AddStepDialog() (+93 more)
...
Cohesion: 0.05
Nodes (47): exportHistory, CacheService, buildExportAuditEntry(), computeExportHash(), ExportAuditEntry, ExportMetadata, ExportRequest, ExportResult (+39 more)

### Community 16 - "itemMatchingEngine.ts"
Cohesion: 0.11
Nodes (33): appendTraceStep(), computeReplaySnapshot(), CopilotDecisionTrace, createCopilotDecisionTrace(), TraceStep, TraceStepType, verifyReplay(), CopilotRecommendation (+25 more)
...
Cohesion: 0.04
Nodes (48): adminProcedure, ORG_ROLE_RANK, requireUser, resolveTenant, t, tenantProcedure, activitiesRouter, aiUsageRouter (+40 more)
...
Cohesion: 0.07
Nodes (52): buildRecommendation(), clamp01(), ClauseCompatibilityResult, ClauseHierarchyNode, ClauseItemLink, ClauseRecommendation, ClauseRecommendationContext, ClauseRiskLink (+44 more)
...
Cohesion: 0.04
Nodes (57): Auditoria e Logs, Auto-save no Editor, Backend de Comentários, Cache de Embeddings, Colaboração em Processos, Configurações de Cabeçalho e Rodapé, Correção de Bugs Críticos, Correções de TypeScript Realizadas (+49 more)
...
Cohesion: 0.01
Nodes (135): ChecklistPreviewDialogWrapper(), Props, TemplateInstructionsDialog(), Props, TemplatePreviewDialogWrapper(), ChecklistPreviewDialog(), TemplatePreviewDialog(), AuditTimeline() (+127 more)
...
Cohesion: 0.09
Nodes (43): environmentDiagnostic(), AI_EXECUTION_POLICIES, AIExecutionPolicy, AITaskId, ALL_AI_TASKS, getExecutionPolicy(), ProviderName, ALL_PROVIDER_NAMES (+35 more)
...
Cohesion: 0.07
Nodes (35): main(), diffSchema(), SchemaDiff, toSnake(), MISSING_COLUMNS, MISSING_COLUMNS_TOTAL, MISSING_TABLES, bootstrap() (+27 more)
...
Cohesion: 0.08
Nodes (37): emailOutbox, EmailOutboxMessage, calculateBackoffMs(), isRetryable(), RetryPolicy, RetryPolicyName, log, optStr() (+29 more)
...
Cohesion: 0.14
Nodes (23): BindingExplanation, explainBinding(), TYPE_REASON, articlesOfKnowledgeUnit(), bindingsByArticle(), bindingsByType(), knowledgeUnitsOfArticle(), listLineages() (+15 more)
...
Cohesion: 0.06
Nodes (70): Citation, computeReplayHash(), ContextDocument, ContextExplainabilityEntry, ContextPackage, createContextPackage(), CreateContextPackageParams, RetrievedPassage (+62 more)
...
Cohesion: 0.11
Nodes (34): BindingGraphEdge, BindingGraphNode, BindingProjection, projectBindings(), sampleBindingRegistry(), BindingValidation, validateBindingRegistry(), BindingChange (+26 more)

### Community 147 - "operationalStabilityService.ts"
Cohesion: 0.05
Nodes (90): businessDomainsTable, domainNavigationTable, domainWorkspacesTable, kernelServicesTable, licensedModulesTable, moduleDependenciesTable, moduleFeatureFlagsTable, organizationFeaturesTable (+82 more)
...
Cohesion: 0.03
Nodes (73): AdminOrganizacoesShellRoute, App(), AuthenticatedRoute(), ContratosWorkspaceShellRoute, DirectProcurementShellRoute, OperationsHomeShellRoute, ParecerJuridicoShellRoute, ProcessosShellRoute (+65 more)
...
Cohesion: 0.07
Nodes (36): AI_ALLOW_MOCK_FALLBACK, AIProviderName, DEFAULT_MODEL_BY_PROVIDER, KNOWN_DEAD_MODEL_IDS, LEGAL_ANALYSIS_MAX_OUTPUT_TOKENS, mockFallbackAllowed(), MODEL_ID_PREFIX_BY_PROVIDER, resolveAiRuntime() (+28 more)

### Community 154 - "sprint501-business-domains.test.ts"
Cohesion: 0.05
Nodes (62): institutionalConsultationSourcesTable, fromDbDatetime(), mysqlConsultationRepository, recordValues(), Row, rowToRecord(), rowToSource(), SrcRow (+54 more)
...
Cohesion: 0.04
Nodes (111): ALL_BLOCK_KINDS, blockFingerprint(), createBlock(), CreateBlockParams, createFragment(), KnowledgeBlock, KnowledgeFragment, computeDocumentLineage() (+103 more)
...
Cohesion: 0.06
Nodes (42): InsertOrganization, InsertOrganizationMember, InstitutionalInvitation, Organization, organizations, addMemberToOrg(), countActiveAdmins(), createOrganization() (+34 more)
...
Cohesion: 0.02
Nodes (94): CandidateCardProps, sourceLabels, CandidateComparisonViewProps, CandidateData, MEDALS, RankingItem, RankingVisualizationProps, ChecklistTab() (+86 more)
...
Cohesion: 0.10
Nodes (27): AI_CONFIG, checkDb(), checkEnv(), checkS3(), REQUIRED_ENV_KEYS, systemRouter, clearHealthCheckRuns(), cognitiveModules() (+19 more)
...
Cohesion: 0.03
Nodes (108): InsertUser, institutionalInvitations, PasswordResetToken, passwordResetTokens, EMAIL_CONFIG, ENV, getOrganizationById(), bumpTokenVersion() (+100 more)
...
Cohesion: 0.13
Nodes (15): AceitarConvite(), ORG_ROLE_LABELS, AdminOrganizacoes(), EsqueciSenha(), RedefinirSenha(), formatDate(), Usuarios(), AUTH_ERROR_MESSAGES (+7 more)
...
Cohesion: 0.22
Nodes (8): 1. Verificação de domínio no painel Brevo (pré-requisito), 2. Variáveis de ambiente por ambiente, 3. Investigar falha de entrega, 4. Replay de `permanent_failure`, 5. Query de duplicatas de e-mail (pré-migration / pré-deploy), 6. Escopo do Resend legado, LiciGov Pro · Convites institucionais e recuperação de senha, Runbook — E-mail Transacional via Brevo (PR A.1)
...
Cohesion: 0.05
Nodes (90): protectedProcedure, ClauseItemInput, ClauseTemplate, injectLegalReference(), selectClauseTemplate(), ExtractionProvenance, ReviewActor, appendItemReviewTransition() (+82 more)
...
Cohesion: 0.04
Nodes (60): documentAttachments, featureFlags, idempotencyKeys, OrganizationMember, organizationMembers, outboxDeadLetters, outboxEvents, tenantFeatureFlags (+52 more)
...
## Knowledge Gaps
- **6260 isolated node(s):** `OperationsHomeShellRoute`, `ProcessosShellRoute`, `DirectProcurementShellRoute`, `ParecerJuridicoShellRoute`, `ContratosWorkspaceShellRoute` (+6255 more)
...
- **Why does `getDb()` connect `getDb` to `entityResolutionService.ts`, `schema.ts`, `trpc.ts`, `Refatoração e Landing Page`, `Fase 14 - Completar Interface Administrativa`, `suggestions.ts`, `institutionalRequests.ts`, `sprint25-hardening.test.ts`, `ComponentShowcase.tsx`, `csvParser.ts`, `CopilotCenter.tsx`, `sprint50-workspace.test.ts`, `operationalStabilityService.ts`, `baseParser.ts`, `priceResearch.ts`, `procurementOntologyService.ts`, `sprint501-business-domains.test.ts`, `procurementProcessService.ts`, `DocumentsWorkspace.tsx`, `knowledgeGraph.ts`, `documentsRouter.ts`, `TaskChartsSection.tsx`, `legalOpinions.ts`, `@radix-ui/react-aspect-ratio`, `CopilotType`, `WorkspaceOverview.tsx`, `sprint33-collaboration-interop.test.ts`, `context-menu.tsx`, `tasks.ts`, `OperationalDashboardPage.tsx`, `organizationsRouter.ts`, `institutionalRetrievalService.ts`, `VersionHistoryDialog.tsx`, `sprint5xx-consolidation.test.ts`, `LiciGov Pro — Visão do Domínio`, `webhookRouter.ts`, `catalogSearchEngine.ts`, `procurement.ts`, `institutionalDeployment.ts`, `dependencies`, `graphRecommendationService.ts`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `dependencies` connect `@trpc/react-query` to `Git e Commits`, `documentsRouter.ts`, `dotenv`, `@radix-ui/react-slider`, `exceljs`, `input-otp`, `jspdf`, `helmet`, `input-otp`, `jspdf`, `react-day-picker`, `Funcionalidades Avançadas`, `@tiptap/extension-placeholder`, `bindingObservabilityService.ts`, `reviewWorkspaceRouter.ts`, `marked`, `next-themes`, `openai`, `@radix-ui/react-aspect-ratio`, `nanoid`, `@radix-ui/react-checkbox`, `@radix-ui/react-collapsible`, `pdfkit`, `@radix-ui/react-context-menu`, `embla-carousel-react`, `@radix-ui/react-avatar`, `@radix-ui/react-radio-group`, `@radix-ui/react-dialog`, `@radix-ui/react-select`, `@radix-ui/react-hover-card`, `@radix-ui/react-toggle-group`, `@radix-ui/react-label`, `react-resizable-panels`, `@types/pdfkit`, `@radix-ui/react-menubar`, `@radix-ui/react-navigation-menu`, `@radix-ui/react-progress`, `@radix-ui/react-switch`, `react-hook-form`, `tailwind-merge`, `@radix-ui/react-scroll-area`, `procurementProcessRouter.ts`, `@radix-ui/react-tabs`, `react-dom`, `tailwindcss-animate`, `@radix-ui/react-dropdown-menu`, `resend`, `@tiptap/starter-kit`, `@trpc/server`, `mysql2`, `CollaborationTimeline.tsx`, `OrgRole`, `NovoProcessoWizard.tsx`, `@trpc/client`, `validationEngine.ts`, `use-debounce`, `vaul`, `wouter`, `externalStorageFoundation.ts`, `@aws-sdk/client-s3`, `@tanstack/react-query`, `@radix-ui/react-slot`, `streamdown`, `@types/pdfkit`, `package.json`, `framer-motion`, `xlsx`, `openai`, `aiUsage.ts`, `@aws-sdk/s3-request-presigner`, `axios`, `class-variance-authority`, `@radix-ui/react-tooltip`, `@tiptap/react`, `react-hook-form`, `@dnd-kit/core`, `@dnd-kit/utilities`?**
...
- **What connects `OperationsHomeShellRoute`, `ProcessosShellRoute`, `DirectProcurementShellRoute` to the rest of the system?**
  _6260 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `schema.ts` be split into smaller, more focused modules?**
  _Cohesion score 0.005374767907749438 - nodes in this community are weakly interconnected._
- **Should `card.tsx` be split into smaller, more focused modules?**
  _Cohesion score 0.0175 - nodes in this community are weakly interconnected._
- **Should `trpc.ts` be split into smaller, more focused modules?**
  _Cohesion score 0.02630453378956373 - nodes in this community are weakly interconnected._