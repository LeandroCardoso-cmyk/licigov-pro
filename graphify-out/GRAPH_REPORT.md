...
## Corpus Check
- 1965 files · ~2,577,677 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 14691 nodes · 28115 edges · 1151 communities (721 shown, 430 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 72 edges (avg confidence: 0.72)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b65b5b6e`
...
## Communities (1151 total, 430 thin omitted)
...
### Community 2 - "trpc.ts"
Cohesion: 0.03
Nodes (136): documentDrafts, documents, documentTimeline, BaseTenantRepository, DocumentRepository, DocumentRow, batchByIds(), batchByKey() (+128 more)

### Community 3 - "getDb"
Cohesion: 0.02
Nodes (167): activityLogs, AIUsageTracking, auditLogs, comments, companyDocuments, contractRenewals, DocumentSettings, documentTemplates (+159 more)
...
Cohesion: 0.11
Nodes (24): createApprovalChain(), createPilotOrganization(), _alerts, computeWorkflowAnalytics(), ContinuousOperationAnalysis, DegradationAnalysis, detectUsageAlerts(), endSession() (+16 more)
...
Cohesion: 0.07
Nodes (81): Props, Props, Props, CandidateDecisionModalProps, CandidateInfo, AddStepDialog(), Props, ChecklistStep (+73 more)

### Community 10 - "clauseIntelligence.ts"
Cohesion: 0.07
Nodes (38): DocActionsProps, DocTabContent(), formatDate(), Props, DocStatus, DocumentApprovalPanel(), Props, STATUS_CONFIG (+30 more)

### Community 11 - "sprint25-hardening.test.ts"
Cohesion: 0.05
Nodes (65): documentRenderCache, documentVersions, OrgRole, BlockDiff, computeDiff(), diffBlocks(), DiffChangeType, diffMetadata() (+57 more)
...
Cohesion: 0.08
Nodes (64): lawyerAssignmentsTable, legalOpinionDraftsTable, legalOpinionHistoryTable, legalOpinionTemplatesTable, legalOpinionVersionsTable, legalOpinionWorkspacesTable, listPendingForDomain(), countLegalOpinionHistory() (+56 more)
...
Cohesion: 0.05
Nodes (41): TrpcContext, adminProcedure, ORG_ROLE_RANK, requireUser, resolveTenant, t, activitiesRouter, aiUsageRouter (+33 more)
...
Cohesion: 0.05
Nodes (102): protectedProcedure, buildClauseHierarchy(), buildRecommendation(), clamp01(), ClauseCompatibilityResult, ClauseHierarchyNode, ClauseItemInput, ClauseItemLink (+94 more)
...
### Community 29 - "react"
Cohesion: 0.12
Nodes (28): Citation, computeReplayHash(), ContextDocument, ContextExplainabilityEntry, ContextPackage, createContextPackage(), CreateContextPackageParams, RetrievedPassage (+20 more)
...
Cohesion: 0.07
Nodes (58): entityResolutionsTable, graphChangeLogTable, graphMetricsTable, graphVersionsTable, knowledgeEdgesTable, knowledgeNodesTable, procurementConceptsTable, conceptRowToDto() (+50 more)

### Community 32 - "promptOrchestrationRouter.ts"
Cohesion: 0.11
Nodes (27): ContextAssembly, applyFallback(), buildExecutionPlan(), createPromptChain(), createPromptStage(), genId(), getNextStages(), PromptChain (+19 more)

### Community 33 - "documentsRouter.ts"
Cohesion: 0.16
Nodes (24): lawChunks, @google/generative-ai, @google/generative-ai, ALLOWED_MIME_TYPES, log, testRAG(), testRAG(), cosineSimilarity() (+16 more)
...
Cohesion: 0.11
Nodes (24): addFragmentToLayer(), ContextLayer, estimateTokens(), contextRouter, assembleContext(), assembleContextService(), AssembledContext, assembleForQuery() (+16 more)

### Community 40 - "sprint42-context-engine.test.ts"
Cohesion: 0.01
Nodes (141): BusinessDomainCode, DomainWorkspaceLauncherProps, LicensedModulesPanel(), Plan, planBadgeClasses(), LicensingDashboard(), planBadgeClasses(), BusinessDomainCode (+133 more)
...
Cohesion: 0.08
Nodes (59): officialDocumentsTable, officialDocumentTimelineTable, ProviderNotImplemented, countDocumentTimeline(), countVersions(), getLatestByLineage(), getOfficialDocument(), insertDocumentTimelineEntry() (+51 more)
...
Cohesion: 0.03
Nodes (83): AuditTimeline(), ChecklistTab(), ContractDocumentsTab(), Props, ContractHistoryTab(), Props, AuditLog, ContractData (+75 more)
...
Cohesion: 0.08
Nodes (52): explainNode(), NormativeExplanation, ALL_NORMATIVE_LEVELS, canContain(), getNormativeLevel(), isNormativeLevel(), levelPath(), NORMATIVE_HIERARCHY (+44 more)
...
Cohesion: 0.07
Nodes (37): organizations, express, express, bootstrap(), ensureSchema(), log(), MIGRATIONS_FOLDER, runMigrations() (+29 more)
...
Cohesion: 0.06
Nodes (54): DOCUMENT_TYPES, DocumentUploadDialog(), UploadData, AIHistoryTable(), AIRecord, OPERATION_LABELS, Props, AIMetricsGrid() (+46 more)
...
Cohesion: 0.08
Nodes (16): fromDbDatetime(), mysqlConsultationRepository, recordValues(), Row, rowToRecord(), rowToSource(), SrcRow, toDbDatetime() (+8 more)

### Community 89 - "legalReasoningEngine.ts"
Cohesion: 0.22
Nodes (13): Process, aiAssistantRouter, documentsRouter, log, processesRouter, makeContext(), mockAdmin, mockDocument (+5 more)

### Community 90 - "catalogSearchEngine.ts"
Cohesion: 0.12
Nodes (27): listOperationalEvents(), listOperationalTimeline(), listOperationRecords(), listDirectProcurementWorkspaces(), computeIndicators(), CONCLUDED_CONTRACT, CONCLUDED_PROCESS, ConsolidatedInput (+19 more)
...
Cohesion: 0.10
Nodes (38): inferTenantLocation(), InstitutionalContextInput, resolveInstitutionalContext(), UserContext, classifyApplicability(), ConsultationIntent, decideSourceScope(), DecideSourceScopeInput (+30 more)
...
Cohesion: 0.05
Nodes (89): generatedDocumentsTable, intelligentItemsTable, itemCatmatMatchesTable, itemHistoryTable, itemRecommendationsTable, itemRisksTable, priceResearchItemsTable, priceResearchTable (+81 more)
...
Cohesion: 0.07
Nodes (60): copilotDecisionTracesTable, copilotMetricsTable, copilotPoliciesTable, copilotRecommendationsTable, copilotSessionsTable, copilotsTable, tenantProcedure, getCopilotPolicy() (+52 more)
...
Cohesion: 0.09
Nodes (24): orgRoleProcedure(), validateTemplate(), onboardingRouter, ActionType, _auditLog, auditPermissionCheck(), checkDepartmentPermission(), checkWorkflowPermission() (+16 more)
...
Cohesion: 0.11
Nodes (10): downloadRouter, documentConverter, generateItemsSpreadsheet(), getSpreadsheetFileName(), ProcessItem, PLATFORM_INSTRUCTIONS_FALLBACK, generateProcessReport(), generatePublicationZip() (+2 more)
...
Cohesion: 0.04
Nodes (64): documentAttachments, featureFlags, idempotencyKeys, importStagingItems, outboxDeadLetters, outboxEvents, tenantFeatureFlags, assertTenantOwnership() (+56 more)
...
Cohesion: 0.09
Nodes (23): Attachment, formatFileSize(), Props, TaskAttachments(), TaskComments(), PRIORITY_COLORS, PRIORITY_LABELS, STATUS_COLORS (+15 more)
...
Cohesion: 0.08
Nodes (41): operationalEventsTable, operationalMilestonesTable, operationalSettingsTable, operationalTimelineTable, operationRecordsTable, publicationRecordsTable, countOperationalTimeline(), getOperationalSettings() (+33 more)
...
Cohesion: 0.03
Nodes (74): App(), AuthenticatedRoute(), ContratosWorkspaceShellRoute, DirectProcurementShellRoute, OperationsHomeShellRoute, ParecerJuridicoShellRoute, ProcessosShellRoute, TirarDuvidasShellRoute (+66 more)
...
Cohesion: 0.06
Nodes (43): AI_ALLOW_MOCK_FALLBACK, AIProviderName, DEFAULT_MODEL_BY_PROVIDER, KNOWN_DEAD_MODEL_IDS, LEGAL_ANALYSIS_MAX_OUTPUT_TOKENS, mockFallbackAllowed(), MODEL_ID_PREFIX_BY_PROVIDER, resolveAiRuntime() (+35 more)

### Community 154 - "sprint501-business-domains.test.ts"
Cohesion: 0.09
Nodes (45): getOrganizationInstitutionalProfile(), AUTHORITY_LABEL, buildApplicabilityCaveat(), buildConsultationAnswer(), classifyEvidenceSufficiency(), computeAnswerId(), computeExecutionId(), computeReplayId() (+37 more)
...
Cohesion: 0.04
Nodes (84): blockFingerprint(), KnowledgeDocument, analyzeImpact(), blockMap(), buildChangeSet(), buildMigrationPlan(), buildRollback(), buildUpgrade() (+76 more)
...
Cohesion: 0.15
Nodes (18): createExpirationEvents(), createOperationalEvent(), EXPIRATION_ALERT_OFFSETS, EXPIRATION_TYPE, subtractDays(), WORKFLOW_ONLY, appendOperationalTimeline(), createOperationalTimelineEntry() (+10 more)
...
Cohesion: 0.19
Nodes (21): getDirectProcedure(), insertGeneratedPublication(), upsertContractJustification(), upsertPriceJustification(), insertResearch(), insertResearchItem(), recordProcessEvent(), createContractJustification() (+13 more)
...
Cohesion: 0.15
Nodes (17): AI_EXECUTION_POLICIES, AIExecutionPolicy, AITaskId, ALL_AI_TASKS, getExecutionPolicy(), ALL_PROVIDER_NAMES, isProviderImplemented(), PROVIDER_ADAPTERS (+9 more)
...
Cohesion: 0.07
Nodes (20): queryClient, trpcClient, OrganizationMember, User, getSessionCookieOptions(), isSecureRequest(), LOCAL_HOSTS, isNonEmptyString() (+12 more)
...
Cohesion: 0.10
Nodes (27): environmentDiagnostic(), checkDb(), checkEnv(), checkS3(), REQUIRED_ENV_KEYS, systemRouter, productionReadinessReport, clearHealthCheckRuns() (+19 more)
...
Cohesion: 0.14
Nodes (16): WorkflowStage, bumpTemplateVersion(), ClauseTemplateRef, customizeTemplate(), DEFAULT_WORKFLOW, getGlobalTemplates(), getTemplateByCategory(), getTemplateProvenance() (+8 more)
...
Cohesion: 0.05
Nodes (53): InsertUser, PasswordResetToken, passwordResetTokens, bumpTokenVersion(), createUser(), getUserByEmail(), getUserById(), normalizeEmailInput() (+45 more)
...
Cohesion: 0.27
Nodes (10): getResponseForRequest(), listDocumentReferences(), listRequestTimeline(), listLegalOpinionHistory(), listLegalOpinionVersions(), LegalOpinionDraft, LegalOpinionWorkspace, getLegalOpinionResult() (+2 more)
...
Cohesion: 0.10
Nodes (21): archiver, clsx, cmdk, mysql2, dependencies, archiver, clsx, cmdk (+13 more)
...
Cohesion: 0.28
Nodes (5): organizationMembers, getMembership(), log, resolveTenantForUser(), TenantResolution
...
Cohesion: 0.13
Nodes (18): CollaborationTimeline(), CollaborationTimelineProps, getEventIcon(), getEventLabel(), TimelineEvent, CollaborationWorkspacePage(), CollaborationWorkspacePageProps, CommentComposer() (+10 more)
...
## Knowledge Gaps
- **6181 isolated node(s):** `OperationsHomeShellRoute`, `ProcessosShellRoute`, `DirectProcurementShellRoute`, `ParecerJuridicoShellRoute`, `ContratosWorkspaceShellRoute` (+6176 more)
...
- **Why does `getDb()` connect `getDb` to `entityResolutionService.ts`, `trpc.ts`, `Refatoração e Landing Page`, `Fase 14 - Completar Interface Administrativa`, `suggestions.ts`, `institutionalRequests.ts`, `sprint25-hardening.test.ts`, `ComponentShowcase.tsx`, `csvParser.ts`, `CopilotCenter.tsx`, `sprint50-workspace.test.ts`, `operationalStabilityService.ts`, `priceResearch.ts`, `sprint501-business-domains.test.ts`, `procurementProcessService.ts`, `DocumentsWorkspace.tsx`, `knowledgeGraph.ts`, `documentsRouter.ts`, `TaskChartsSection.tsx`, `input-group.tsx`, `legalOpinions.ts`, `@radix-ui/react-aspect-ratio`, `CopilotType`, `WorkspaceOverview.tsx`, `limitsMiddleware.ts`, `Dívidas Conhecidas`, `tasks.ts`, `OperationalDashboardPage.tsx`, `organizationsRouter.ts`, `institutionalRetrievalService.ts`, `VersionHistoryDialog.tsx`, `sprint5xx-consolidation.test.ts`, `knowledgeEdge.ts`, `procurementProcessRouter.ts`, `catalogSearchEngine.ts`, `externalStorageFoundation.ts`, `bindingObservabilityService.ts`, `procurement.ts`, `moduleLicensingService.ts`, `institutionalDeployment.ts`, `ItemIntelligenceWorkspace.tsx`, `Fase 13 - Melhorias UX do Sistema de Plataformas`, `featureFlagService.ts`, `dependencies`, `graphRecommendationService.ts`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `dependencies` connect `@trpc/react-query` to `documentsRouter.ts`, `lucide-react`, `axios`, `html2canvas`, `sprint42-context-engine.test.ts`, `class-variance-authority`, `input-otp`, `jspdf`, `marked`, `@radix-ui/react-hover-card`, `react-day-picker`, `@tiptap/extension-placeholder`, `bindingObservabilityService.ts`, `bootstrap.ts`, `document-generation-mysql-smoke.test.ts`, `class-variance-authority`, `docx`, `dotenv`, `drizzle-kit`, `embla-carousel-react`, `eslint`, `helmet`, `nanoid`, `next-themes`, `Fase 12 - Histórico de Versões`, `@dnd-kit/sortable`, `jose`, `autoprefixer`, `@radix-ui/react-progress`, `@radix-ui/react-radio-group`, `@radix-ui/react-scroll-area`, `@radix-ui/react-tabs`, `react-dom`, `@dnd-kit/core`, `tailwindcss-animate`, `drizzle-orm`, `jspdf`, `openai`, `@radix-ui/react-context-menu`, `@radix-ui/react-dropdown-menu`, `@radix-ui/react-menubar`, `@radix-ui/react-switch`, `react-hook-form`, `resend`, `@tiptap/starter-kit`, `@trpc/server`, `mysql2`, `@radix-ui/react-accordion`, `CollaborationTimeline.tsx`, `OrgRole`, `NovoProcessoWizard.tsx`, `react-resizable-panels`, `tailwind-merge`, `@trpc/client`, `use-debounce`, `vaul`, `wouter`, `@tanstack/react-query`, `CopilotComparisonPanel.tsx`, `@radix-ui/react-select`, `date-fns`, `@radix-ui/react-label`, `@radix-ui/react-slot`, `streamdown`, `@types/pdfkit`, `package.json`, `framer-motion`, `xlsx`, `openai`, `@radix-ui/react-aspect-ratio`, `@radix-ui/react-dialog`, `@radix-ui/react-switch`, `@radix-ui/react-tooltip`, `@tiptap/react`, `react-hook-form`, `@tiptap/starter-kit`, `mysql2`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `cn()` connect `cn` to `card.tsx`, `serviceHealthService.ts`, `operationalIncident.ts`, `sprint42-context-engine.test.ts`, `ContractDetails.tsx`, `clauseIntelligence.ts`, `workspaceDecisionService.ts`, `utils.ts`, `ExportCard.tsx`, `🎯 Critérios de Sucesso`, `workspaceRiskService.ts`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
...
- **Should `card.tsx` be split into smaller, more focused modules?**
  _Cohesion score 0.018361332154435604 - nodes in this community are weakly interconnected._
- **Should `trpc.ts` be split into smaller, more focused modules?**
  _Cohesion score 0.02701739378386085 - nodes in this community are weakly interconnected._