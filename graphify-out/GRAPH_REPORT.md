...
## Corpus Check
- 1992 files · ~2,595,318 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 14855 nodes · 28670 edges · 1144 communities (713 shown, 431 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 72 edges (avg confidence: 0.72)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b756580c`
...
## Communities (1144 total, 431 thin omitted)
...
### Community 2 - "trpc.ts"
Cohesion: 0.02
Nodes (154): activityLogs, documentAttachments, documentDrafts, documents, documentTimeline, BaseTenantRepository, DocumentRepository, DocumentRow (+146 more)
...
Cohesion: 0.06
Nodes (50): exportHistory, exportRouter, CatalogEntryType, buildExportAuditEntry(), computeExportHash(), ExportAuditEntry, ExportMetadata, ExportRequest (+42 more)

### Community 16 - "itemMatchingEngine.ts"
Cohesion: 0.09
Nodes (37): CopilotCapability, CopilotDecisionTrace, CopilotPolicy, createCopilotPolicy(), evaluatePolicy(), PolicyEvaluation, RISK_RANK, aggregateRiskLevel() (+29 more)
...
Cohesion: 0.03
Nodes (82): OrganizationMember, Process, User, TrpcContext, sdk, adminProcedure, ORG_ROLE_RANK, protectedProcedure (+74 more)
...
Cohesion: 0.08
Nodes (39): businessDomainsTable, domainNavigationTable, domainWorkspacesTable, kernelServicesTable, licensedModulesTable, moduleDependenciesTable, moduleFeatureFlagsTable, organizationFeaturesTable (+31 more)
...
Cohesion: 0.08
Nodes (49): entityResolutionsTable, graphChangeLogTable, graphMetricsTable, graphVersionsTable, knowledgeEdgesTable, knowledgeNodesTable, procurementConceptsTable, conceptRowToDto() (+41 more)
...
Cohesion: 0.05
Nodes (60): EmbeddingCache, lawChunks, @google/generative-ai, @google/generative-ai, isNonEmptyString(), SDKServer, chunkSize, extractArticleNumber() (+52 more)
...
Cohesion: 0.07
Nodes (46): addFragmentToLayer(), assembleContext(), assembleRAGContext(), compressRAGContext(), ContextAssembly, ContextLayer, ContextSource, ContextWindow (+38 more)
...
Cohesion: 0.07
Nodes (46): evaluateConditionalClause(), addDecision(), approveCandidate(), attachEvidence(), buildDecision(), compareCandidates(), createContract(), escalateReview() (+38 more)
...
Cohesion: 0.07
Nodes (37): digitalSignatures, Document, InsertDigitalSignature, InsertLegalOpinion, legalOpinions, SignatureHistory, addSignatureToHistoryForOrganization(), createDigitalSignature() (+29 more)
...
Cohesion: 0.06
Nodes (69): cognitiveObservabilityTable, environmentDiagnostic(), AI_EXECUTION_POLICIES, AIExecutionPolicy, AITaskId, ALL_AI_TASKS, getExecutionPolicy(), ALL_PROVIDER_NAMES (+61 more)
...
Cohesion: 0.07
Nodes (69): createBlock(), createSection(), buildPipeline(), createInstitutionalPipelineDefinition(), executePipeline(), samplePipeline(), KnowledgePublisher, explainNode() (+61 more)
...
Cohesion: 0.12
Nodes (20): bootstrap(), ensureSchema(), log(), MIGRATIONS_FOLDER, runMigrations(), seedAdmin(), seedDefaultOrgMembership(), APP_CONFIG (+12 more)
...
Cohesion: 0.08
Nodes (32): ALIAS_MAP, normalizeUnit(), REGISTRY, UnitCategory, UnitEntry, UnitNormalizationResult, addEvidenceEntry(), buildHumanCorrectionEvidence() (+24 more)
...
Cohesion: 0.08
Nodes (40): inferTenantLocation(), InstitutionalContext, InstitutionalContextInput, UserContext, explainOfficialDocument(), OfficialDocumentExplanation, addOfficialDocument(), buildOfficialCorpora() (+32 more)
...
Cohesion: 0.11
Nodes (23): emailOutbox, EmailOutboxMessage, EMAIL_CONFIG, calculateBackoffMs(), isRetryable(), RetryPolicy, RetryPolicyName, kick() (+15 more)
...
Cohesion: 0.07
Nodes (52): Citation, ContextDocument, ContextExplainabilityEntry, CreateContextPackageParams, RetrievedPassage, resolveInstitutionalContext(), classifyApplicability(), ConsultationIntent (+44 more)
...
Cohesion: 0.06
Nodes (68): copilotDecisionTracesTable, copilotMetricsTable, copilotPoliciesTable, copilotRecommendationsTable, copilotSessionsTable, copilotsTable, getCopilotPolicy(), getCopilotSession() (+60 more)
...
Cohesion: 0.20
Nodes (17): log, optStr(), renderTemplate(), buildInvitationContent(), buildInvitationEmail(), buildInvitationResentEmail(), buildPasswordChangedEmail(), buildPasswordResetEmail() (+9 more)
...
Cohesion: 0.09
Nodes (49): code(), getDomainWorkspace(), insertDomainWorkspace(), upsertBusinessDomain(), upsertKernelService(), upsertModuleDependency(), AssembledProcess, assembleProcess() (+41 more)
...
Cohesion: 0.08
Nodes (32): mockFallbackAllowed(), ProviderName, GeminiProvider, mapFinishReason(), SAFETY_SETTINGS, shouldDisableThinking(), THINKING_DISABLE_COMPATIBLE_MODELS, MockAIProvider (+24 more)

### Community 154 - "sprint501-business-domains.test.ts"
Cohesion: 0.06
Nodes (64): LEGAL_ANALYSIS_MAX_OUTPUT_TOKENS, setActiveProvider(), mysqlConsultationRepository, getOrganizationInstitutionalProfile(), AUTHORITY_LABEL, buildApplicabilityCaveat(), buildConsultationAnswer(), classifyEvidenceSufficiency() (+56 more)
...
Cohesion: 0.05
Nodes (64): blockFingerprint(), createReference(), createRelationship(), sampleKnowledgeDocument(), analyzeImpact(), blockMap(), buildChangeSet(), buildMigrationPlan() (+56 more)
...
Cohesion: 0.06
Nodes (43): InsertOrganization, InsertOrganizationMember, InstitutionalInvitation, Organization, organizations, addMemberToOrg(), countActiveAdmins(), createOrganization() (+35 more)
...
Cohesion: 0.35
Nodes (9): getFeatureFlag(), upsertFeatureFlag(), createFeatureFlag(), FeatureFlag, isFeatureEnabled(), RolloutStrategy, toggleFeature(), isModuleFeatureEnabled() (+1 more)
...
Cohesion: 0.22
Nodes (11): AI_ALLOW_MOCK_FALLBACK, AI_CONFIG, AIProviderName, DEFAULT_MODEL_BY_PROVIDER, KNOWN_DEAD_MODEL_IDS, MODEL_ID_PREFIX_BY_PROVIDER, resolveAiRuntime(), resolveAllowMockFallback() (+3 more)
...
Cohesion: 0.03
Nodes (110): InsertUser, institutionalInvitations, PasswordResetToken, passwordResetTokens, getSessionCookieOptions(), isSecureRequest(), LOCAL_HOSTS, ENV (+102 more)
...
Cohesion: 0.04
Nodes (106): buildRecommendation(), clamp01(), ClauseCompatibilityResult, ClauseHierarchyNode, ClauseItemInput, ClauseItemLink, ClauseRecommendation, ClauseRecommendationContext (+98 more)
...
Cohesion: 0.10
Nodes (21): @aws-sdk/s3-request-presigner, clsx, cmdk, mysql2, dependencies, @aws-sdk/s3-request-presigner, clsx, cmdk (+13 more)
...
- **Why does `getDb()` connect `getDb` to `schema.ts`, `trpc.ts`, `operationalGovernance.ts`, `NewDirectContract.tsx`, `Fase 14 - Completar Interface Administrativa`, `suggestions.ts`, `institutionalRequests.ts`, `sprint25-hardening.test.ts`, `ComponentShowcase.tsx`, `csvParser.ts`, `CopilotCenter.tsx`, `sprint50-workspace.test.ts`, `operationalStabilityService.ts`, `baseParser.ts`, `priceResearch.ts`, `interoperabilityObservabilityService.ts`, `sprint29-semantic-review.test.ts`, `procurementOntologyService.ts`, `sprint501-business-domains.test.ts`, `procurementProcessService.ts`, `DocumentsWorkspace.tsx`, `knowledgeGraph.ts`, `documentsRouter.ts`, `TaskChartsSection.tsx`, `legalOpinions.ts`, `@radix-ui/react-aspect-ratio`, `CopilotType`, `WorkspaceOverview.tsx`, `utils.ts`, `context-menu.tsx`, `OperationalDashboardPage.tsx`, `organizationsRouter.ts`, `institutionalRetrievalService.ts`, `VersionHistoryDialog.tsx`, `sprint5xx-consolidation.test.ts`, `LiciGov Pro — Visão do Domínio`, `webhookRouter.ts`, `legalReasoningEngine.ts`, `catalogSearchEngine.ts`, `procurement.ts`, `institutionalDeployment.ts`, `dependencies`?**
