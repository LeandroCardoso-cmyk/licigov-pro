...
## Corpus Check
- 1680 files · ~2,373,617 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 11816 nodes · 22571 edges · 800 communities (648 shown, 152 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 48 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b3262072`
...
## Communities (800 total, 152 thin omitted)
...
Cohesion: 0.02
Nodes (175): ActivityFiltersCard(), Props, ACTION_COLORS, ACTION_LABELS, Activity, ActivityLogCard(), Props, AdminStatsGrid() (+167 more)
...
### Community 3 - "getDb"
Cohesion: 0.02
Nodes (162): AIUsageTracking, auditLogs, catmatSuggestions, comments, companyDocuments, DocumentSettings, documentTemplates, editalParameters (+154 more)

### Community 4 - "documentService.ts"
Cohesion: 0.04
Nodes (104): activityLogs, documentAttachments, documentDrafts, documentTimeline, ComentarioAdicionado, ComentarioAdicionadoPayload, DOCUMENT_EVENT_TYPES, DocumentEventType (+96 more)

### Community 5 - "button.tsx"
Cohesion: 0.05
Nodes (103): Props, Props, AuditTimelineProps, CandidateDecisionModalProps, CandidateInfo, CatmatSuggestionsModalProps, AddStepDialog(), Props (+95 more)
...
Cohesion: 0.07
Nodes (42): AiAssistantPanel(), CommentsSection(), DocActionsProps, DocTabContent(), formatDate(), Props, DocStatus, DocumentApprovalPanel() (+34 more)

### Community 10 - "clauseIntelligence.ts"
Cohesion: 0.13
Nodes (32): AI_EXECUTION_POLICIES, AIExecutionPolicy, AITaskId, ALL_AI_TASKS, getExecutionPolicy(), ProviderName, getProvider(), ALL_PROVIDER_NAMES (+24 more)
...
Cohesion: 0.08
Nodes (52): cognitiveWorkspacesTable, workspaceDecisionsTable, workspaceMetricsTable, workspaceRisksTable, workspaceTasksTable, workspaceTimelineTable, getWorkspace(), insertTimelineEntry() (+44 more)
...
Cohesion: 0.02
Nodes (91): App(), AuthenticatedRoute(), BackToDashboard(), BackToDashboardProps, BreadcrumbItem, Breadcrumbs(), BreadcrumbsProps, Contract (+83 more)
...
Cohesion: 0.11
Nodes (36): lawChunks, @google/generative-ai, @google/generative-ai, ALLOWED_MIME_TYPES, testRAG(), testRAG(), documentsBlock(), fmtBrl() (+28 more)
...
Cohesion: 0.09
Nodes (46): generateText(), CapabilityKind, CopilotCapability, createCopilotCapability(), matchesCapability(), scoreCapabilityMatch(), appendTraceStep(), computeReplaySnapshot() (+38 more)

### Community 38 - "copilotRouter.ts"
Cohesion: 0.08
Nodes (39): copilotDecisionTracesTable, copilotMetricsTable, copilotPoliciesTable, copilotRecommendationsTable, copilotSessionsTable, copilotsTable, tenantProcedure, getCopilotPolicy() (+31 more)
...
Cohesion: 0.14
Nodes (35): officialDocumentsTable, officialDocumentTimelineTable, countDocumentTimeline(), countVersions(), getLatestByLineage(), getOfficialDocument(), insertDocumentTimelineEntry(), insertOfficialDocument() (+27 more)
...
Cohesion: 0.15
Nodes (18): createVectorEmbedding(), isEmbeddingStale(), normalizeVector(), sha256(), VectorEmbedding, semanticRetrievalRouter, getChunks(), batchGenerateEmbeddings() (+10 more)

### Community 55 - "directContractsRouter.ts"
Cohesion: 0.06
Nodes (56): directContractAuditLogs, DirectContractChecklistProgress, directContractDocuments, directContractLegalArticles, directContractQuotations, directContracts, InsertDirectContract, InsertDirectContractAuditLog (+48 more)
...
Cohesion: 0.08
Nodes (35): organizations, express, express, bootstrap(), ensureSchema(), log(), MIGRATIONS_FOLDER, runMigrations() (+27 more)
...
Cohesion: 0.14
Nodes (25): searchKnowledgeNodes(), contextDensity(), createWorkspaceContext(), WorkspaceContext, WorkspaceContextDocument, WorkspaceContextEvidence, CopilotContext, CopilotEvidence (+17 more)
...
Cohesion: 0.12
Nodes (8): Confidence Levels, Imports Architecture, Parsers Disponíveis, Resumo do Fluxo, ADRs Registrados, Architectural Decisions, Lista Resumida, Template de ADR
...
Cohesion: 0.16
Nodes (26): getLicensedModule(), listLicensedModules(), setModuleActive(), upsertLicensedModule(), getBusinessDomainDefinition(), listBusinessDomains(), ALL_KERNEL_SERVICE_IDS, isKernelService() (+18 more)
...
Cohesion: 0.11
Nodes (25): contracts, NotificationPayload, notifyOwner(), validate(), contactRouter, contractsRouter, AmendmentData, ApostilleData (+17 more)
...
Cohesion: 0.04
Nodes (105): generatedDocumentsTable, intelligentItemsTable, itemCatmatMatchesTable, itemHistoryTable, itemRecommendationsTable, itemRisksTable, priceResearchItemsTable, priceResearchTable (+97 more)
...
Cohesion: 0.14
Nodes (21): upsertBusinessDomain(), upsertKernelService(), upsertModuleDependency(), BusinessDomain, createKernelServiceRecord(), getKernelService(), KERNEL_SERVICES, KernelService (+13 more)
...
Cohesion: 0.10
Nodes (23): computeChecksum(), lastIngestionJobs, productionReadinessRouter, CatalogEntryType, CacheConfig, CacheEntry, CacheMetrics, createCacheService() (+15 more)
...
Cohesion: 0.18
Nodes (11): GeminiProvider, mapFinishReason(), SAFETY_SETTINGS, MockAIProvider, sha256(), AIGenerateOptions, AIGenerateResult, AIMessage (+3 more)

### Community 154 - "sprint501-business-domains.test.ts"
Cohesion: 0.11
Nodes (17): FileContent, ImageContent, InvokeParams, InvokeResult, JsonSchema, Message, MessageContent, OutputSchema (+9 more)
...
Cohesion: 0.09
Nodes (24): Process, User, TrpcContext, getSessionCookieOptions(), isSecureRequest(), LOCAL_HOSTS, isNonEmptyString(), sdk (+16 more)
...
Cohesion: 0.16
Nodes (19): businessDomainsTable, domainNavigationTable, domainWorkspacesTable, kernelServicesTable, licensedModulesTable, moduleDependenciesTable, moduleFeatureFlagsTable, organizationFeaturesTable (+11 more)
...
Cohesion: 0.16
Nodes (14): cosineSimilarity(), appendToIndex(), createVectorIndex(), detectOrphans(), getIndex(), getIndicesByCorpus(), IndexStatus, _indices (+6 more)
...
Cohesion: 0.10
Nodes (21): clsx, cmdk, jspdf, mysql2, dependencies, clsx, cmdk, jspdf (+13 more)
...
Cohesion: 0.16
Nodes (10): Step1LegalFramework(), Step2ContractData(), Step3Supplier(), Article, Props, Step4Review(), STEPS, WizardStepper() (+2 more)
...
Cohesion: 0.09
Nodes (28): ItemTRDetailSheet(), ItemTRGrid(), BulkReviewBar(), ReviewActions(), ReviewActionsProps, ReviewDetailPanel(), ReviewDetailPanelProps, stateLabels (+20 more)
...
Cohesion: 0.17
Nodes (12): 1. AIExecutionEngine (`ai_execution_engine`), 2. Provider Adapter (`provider_adapter`), 3. Storage Service (`storage_service`), 4. Document Engine → Storage Service, 5. Banco de Dados — MySQL (oficial), 6. Autenticação — JWT obrigatório, AI Execution Policy, Amazon S3 (oficial) (+4 more)
...
Cohesion: 0.22
Nodes (9): Document Engine — Componente Permanente do Cognitive Kernel (RC-3), Fora de escopo (Future Evolution), Formatos oficiais, Frontend (experiência única), Integração dos Business Domains, Modelo uniforme (`OfficialDocument`), Persistência via Storage Service (RC-3.5), Pipeline único (+1 more)
...
### Community 729 - "businessDomain.ts"
Cohesion: 0.29
Nodes (6): ALL_BUSINESS_DOMAIN_CODES, BASE_KERNEL, BUSINESS_DOMAIN_DEFINITIONS, BusinessDomainCategory, DOMAIN_CODES, PLANS

### Community 736 - "knowledgeNode.ts"
Cohesion: 0.36
Nodes (7): createKnowledgeNode(), deactivateNode(), KnowledgeNode, matchesAlias(), NodeType, normalizeTitle(), updateNodeVersion()

### Community 737 - "directContractDocuments.ts"
Cohesion: 0.52
...
### Community 746 - "TimelinePanel.tsx"
Cohesion: 0.50
...
### Community 779 - "RankingVisualization.tsx"
Cohesion: 0.40
Nodes (3): MEDALS, RankingItem, RankingVisualizationProps

### Community 780 - "SemanticCandidatePanel.tsx"
Cohesion: 0.40
Nodes (3): SemanticCandidateItem, SemanticCandidatePanelProps, sourceLabels

### Community 781 - "🎨 Melhorias de UI e Dashboard (Nova Implementação)"
Cohesion: 0.50
...
### Community 783 - "Fase 15 - Melhorias Finais da Interface Administrativa"
Cohesion: 0.50
...
### Community 795 - "📚 Expansão do Sistema RAG"
Cohesion: 0.67
...
## Knowledge Gaps
- **5046 isolated node(s):** `UseAuthOptions`, `AIChatBoxProps`, `Props`, `Tab`, `Result` (+5041 more)
...
- **Why does `getDb()` connect `getDb` to `trpc.ts`, `documentService.ts`, `institutionalRequests.ts`, `sprint25-hardening.test.ts`, `ComponentShowcase.tsx`, `csvParser.ts`, `sprint50-workspace.test.ts`, `priceResearch.ts`, `workspaceTaskService.ts`, `react`, `knowledgeGraph.ts`, `documentsRouter.ts`, `copilotRouter.ts`, `embeddings.ts`, `legalOpinions.ts`, `authRouter.ts`, `platforms`, `CopilotType`, `sprint33-collaboration-interop.test.ts`, `directContractsRouter.ts`, `context-menu.tsx`, `tasks.ts`, `bootstrap.ts`, `organizationsRouter.ts`, `institutionalRetrievalService.ts`, `departmentOperation.ts`, `VersionHistoryDialog.tsx`, `businessDomainRegistryService.ts`, `contractsRouter.ts`, `legalReasoningEngine.ts`, `catalogSearchEngine.ts`, `operationRecordService.ts`, `directContractDocuments.ts`, `contracts.ts`, `aiUsageTracker.ts`, `procurement.ts`, `moduleLicensingService.ts`, `featureFlagService.ts`, `Funcionalidades Avançadas`, `Fase 16 - Conformidade LGPD`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `dependencies` connect `evidenceRetrievalService.ts` to `cn`, `documentsRouter.ts`, `bootstrap.ts`, `@aws-sdk/client-s3`, `axios`, `bcrypt`, `LiciGov Pro — Decisões Arquiteturais`, `procurementOntologyService.ts`, `@dnd-kit/core`, `@dnd-kit/utilities`, `docx`, `drizzle-orm`, `embla-carousel-react`, `exceljs`, `framer-motion`, `helmet`, `marked`, `nanoid`, `next-themes`, `openai`, `pdfkit`, `@radix-ui/react-aspect-ratio`, `@radix-ui/react-checkbox`, `@radix-ui/react-context-menu`, `@radix-ui/react-dialog`, `@radix-ui/react-dropdown-menu`, `@radix-ui/react-hover-card`, `@radix-ui/react-menubar`, `@radix-ui/react-radio-group`, `@radix-ui/react-scroll-area`, `workspaceRiskService.ts`, `@radix-ui/react-select`, `@radix-ui/react-separator`, `@radix-ui/react-switch`, `@radix-ui/react-tooltip`, `react-dom`, `stripe`, `tailwind-merge`, `tailwindcss-animate`, `@tiptap/extension-placeholder`, `@tiptap/react`, `@trpc/client`, `@trpc/react-query`, `@trpc/server`, `use-debounce`, `vaul`, `wouter`, `@aws-sdk/client-s3`, `framer-motion`, `helmet`, `input-otp`, `@radix-ui/react-alert-dialog`, `@builder.io/vite-plugin-jsx-loc`, `jose`, `lucide-react`, `@radix-ui/react-navigation-menu`, `@radix-ui/react-collapsible`, `@radix-ui/react-popover`, `@radix-ui/react-slider`, `zod`, `@radix-ui/react-slot`, `archiver`, `cookie`, `date-fns`, `package.json`, `@radix-ui/react-avatar`, `react-hook-form`, `react-resizable-panels`, `resend`, `@radix-ui/react-tabs`, `responseValidationService.ts`, `streamdown`, `xlsx`, `dotenv`, `WorkspaceOverview.tsx`, `knowledgeEdge.ts`, `GraphMetricsDashboard.tsx`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `cn()` connect `cn` to `card.tsx`, `button.tsx`, `ContractDetails.tsx`, `workspaceDecisionService.ts`, `useItemTR.ts`, `ProcessDetails.tsx`, `cnpjValidator.ts`, `dlqObservabilityService.ts`, `ExportCard.tsx`, `App.tsx`, `OperationalDashboardPage.tsx`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **What connects `UseAuthOptions`, `AIChatBoxProps`, `Props` to the rest of the system?**
  _5053 weakly-connected nodes found - possible documentation gaps or missing edges._
...
- **Should `card.tsx` be split into smaller, more focused modules?**
  _Cohesion score 0.019749185346104474 - nodes in this community are weakly interconnected._
