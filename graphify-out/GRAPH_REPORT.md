...
## Corpus Check
- 2154 files · ~2,715,710 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 15354 nodes · 31229 edges · 856 communities (733 shown, 123 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 111 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `197132e7`
...
## Communities (856 total, 123 thin omitted)
...
### Community 1 - "App.tsx"
Cohesion: 0.02
Nodes (89): AdminOrganizacoesShellRoute, App(), AuthenticatedRoute(), ContratosWorkspaceShellRoute, DirectProcurementShellRoute, OperationsHomeShellRoute, ParecerJuridicoShellRoute, ProcessosShellRoute (+81 more)

### Community 2 - "documentService.ts"
Cohesion: 0.02
Nodes (151): documentDrafts, DocumentReviewDecisionRow, documentReviewDecisionsTable, documents, documentTimeline, documentVersions, InsertDocumentReviewDecision, BaseTenantRepository (+143 more)

### Community 3 - "getDb"
Cohesion: 0.02
Nodes (214): activityLogs, AIUsageTracking, auditLogs, comments, companyDocuments, directContractAuditLogs, DirectContractChecklistProgress, directContractDocuments (+206 more)
...
### Community 7 - "cn"
Cohesion: 0.02
Nodes (223): AIChatBox(), AIChatBoxProps, Message, DashboardLayoutContent(), DashboardLayoutContentProps, menuItems, THEME_OPTIONS, DashboardLayoutSkeleton() (+215 more)
...
Cohesion: 0.03
Nodes (165): AdminStatsGrid(), Props, StatCardProps, AdminUser, AdminUsersTable(), Props, DOCUMENT_TYPES, ChecklistPreviewDialogWrapper() (+157 more)

### Community 10 - "StagingReviewDrawer.tsx"
Cohesion: 0.09
Nodes (38): StagingReviewDrawer(), StagingReviewDrawerProps, StagingReviewTable(), StagingReviewTableProps, ContractStepper(), LABELS, Step1BasicData(), Step2Contractor() (+30 more)
...
Cohesion: 0.06
Nodes (51): CatalogEntryType, AuditCategory, AuditEvent, AuditQuery, auditStore, AuditSummary, clearAuditStore(), exportAuditTrail() (+43 more)
...
Cohesion: 0.06
Nodes (68): cognitiveWorkspacesTable, workspaceDecisionsTable, workspaceMetricsTable, workspaceRisksTable, workspaceTasksTable, workspaceTimelineTable, getWorkspace(), insertDecision() (+60 more)

### Community 18 - "routers.ts"
Cohesion: 0.05
Nodes (59): SESSION_TTL_MS, TrpcContext, getSessionCookieOptions(), isSecureRequest(), LOCAL_HOSTS, sdk, SessionPayload, adminProcedure (+51 more)
...
Cohesion: 0.02
Nodes (98): BackToDashboard(), BackToDashboardProps, BreadcrumbItem, Breadcrumbs(), BreadcrumbsProps, BusinessDomainCard(), BusinessDomainCardDomain, BusinessDomainCardProps (+90 more)
...
Cohesion: 0.04
Nodes (51): Auto-save no Editor, Backend de Comentários, Backend (Implementado), Cache de Embeddings, Colaboração em Processos, Configurações de Cabeçalho e Rodapé, Correção de Bugs Críticos, Correções de TypeScript Realizadas (+43 more)

### Community 28 - "sprint35-pilot-execution.test.ts"
Cohesion: 0.11
Nodes (28): computeIncidentMetrics(), getCriticalIncidents(), getOpenIncidents(), ACTIVATION_TRANSITIONS, ActivationState, addRiskIndicator(), addRolloutStage(), AdoptionScore (+20 more)
...
Cohesion: 0.05
Nodes (68): EmbeddingCache, lawChunks, @google/generative-ai, @google/generative-ai, AI_CONFIG, GeminiProvider, mapFinishReason(), REQUEST_OPTIONS (+60 more)
...
Cohesion: 0.04
Nodes (59): documentAttachments, documentRenderCache, OrganizationMember, organizationMembers, outboxDeadLetters, outboxEvents, ExportFormat, fail() (+51 more)

### Community 41 - "sprint295-pre-itemtr.test.ts"
Cohesion: 0.06
Nodes (56): addDecision(), approveCandidate(), attachEvidence(), buildDecision(), compareCandidates(), createContract(), escalateReview(), finalizeContract() (+48 more)
...
### Community 46 - "ai.ts"
Cohesion: 0.08
Nodes (33): AI_ALLOW_MOCK_FALLBACK, AI_MAX_ATTEMPTS, AI_TIMEOUT_MS, AIProviderName, DEFAULT_MODEL_BY_PROVIDER, KNOWN_DEAD_MODEL_IDS, MODEL_ID_PREFIX_BY_PROVIDER, resolveAiRuntime() (+25 more)
...
Cohesion: 0.06
Nodes (58): addToHistory(), CacheMetadata, CatalogSnapshot, CatalogSyncHistory, CatalogType, computeChecksum(), createSnapshot(), IntegrityMetadata (+50 more)
...
Cohesion: 0.06
Nodes (49): brl(), ContractAmendmentsTab(), brl(), ContractApostillesTab(), ContractDocumentsTab(), ContractHistoryTab(), DocActionsProps, DocTabContent() (+41 more)
...
Cohesion: 0.06
Nodes (44): idempotencyKeys, officialDocumentPromotionsTable, getLatestOfficialPromotion(), insertOfficialPromotion(), OfficialPromotionRecord, PromoDb, PromotionExecutor, getGeneratedDocumentByKind() (+36 more)
...
### Community 61 - "TaskList.tsx"
Cohesion: 0.08
Nodes (39): AIHistoryTable(), AIRecord, OPERATION_LABELS, Props, CatmatItem, CatmatSearch(), CatmatSearchProps, Props (+31 more)

### Community 62 - "legalOpinions.ts"
Cohesion: 0.07
Nodes (36): contractRenewals, digitalSignatures, InsertDigitalSignature, InsertLegalOpinion, legalOpinions, SignatureHistory, subscriptionPlans, subscriptions (+28 more)
...
Cohesion: 0.08
Nodes (38): inferTenantLocation(), InstitutionalContext, InstitutionalContextInput, resolveInstitutionalContext(), UserContext, explainOfficialDocument(), OfficialDocumentExplanation, addOfficialDocument() (+30 more)
...
Cohesion: 0.09
Nodes (31): express, express, ANALYTICS_CONNECT_SRC, ANALYTICS_IMG_SRC, ANALYTICS_SCRIPT_SRC, buildCspDirectives(), buildHelmetContentSecurityPolicy(), CspDirectives (+23 more)
...
Cohesion: 0.04
Nodes (71): importItemCorrections, importPromotions, importSessions, importStagingItems, priceResearchItemsTable, priceResearchTable, procurementProcessesTable, computeEffectiveContent() (+63 more)
...
Cohesion: 0.05
Nodes (103): Props, DocumentUploadDialog(), Props, UploadData, Props, TemplateInstructionsDialog(), CandidateDecisionModalProps, CandidateInfo (+95 more)
...
### Community 101 - "TRItemsModal.tsx"
Cohesion: 0.03
Nodes (84): AiAssistantPanel(), Props, Result, Tab, TAB_CONFIG, AuditTimeline(), CatmatSuggestionsModal(), ChecklistTab() (+76 more)
...
Cohesion: 0.10
Nodes (32): mockFallbackAllowed(), AI_EXECUTION_POLICIES, AIExecutionPolicy, AITaskId, ALL_AI_TASKS, getExecutionPolicy(), ProviderName, MockAIProvider (+24 more)
...
Cohesion: 0.05
Nodes (66): cognitiveObservabilityTable, environmentDiagnostic(), ALL_PROVIDER_NAMES, PROVIDER_ADAPTERS, checkS3(), countObservabilityForTenant(), getObservabilityByCorrelation(), insertObservability() (+58 more)
...
Cohesion: 0.13
Nodes (18): DOC_TYPE_LABELS, OfficialDocumentPanel(), OfficialDocumentPanelProps, EditalWorkspace(), EditalWorkspaceProps, Form, FORM_LABELS, Modality (+10 more)
...
Cohesion: 0.06
Nodes (35): Document, Process, LEGACY_PROCESS_PIPELINE_DISABLED, throwLegacyProcessPipelineDisabled(), aiAssistantRouter, authRouter, departmentTasksRouter, documentsRouter (+27 more)
...
Cohesion: 0.06
Nodes (31): brl(), ITEM_STATUS_CLASSES, ITEM_STATUS_LABELS, ItemIntelligenceWorkspace(), ItemIntelligenceWorkspaceProps, NovoProcessoWizard(), NovoProcessoWizardProps, START_OPTIONS (+23 more)
...
Cohesion: 0.05
Nodes (76): advancePhase(), applyGovernance(), computeDeploymentHealth(), createDeployment(), DeploymentEvent, DeploymentEventType, DeploymentGovernance, DeploymentPhase (+68 more)
...
Cohesion: 0.09
Nodes (39): CopilotCapability, appendTraceStep(), computeReplaySnapshot(), CopilotDecisionTrace, createCopilotDecisionTrace(), TraceStep, TraceStepType, verifyReplay() (+31 more)
...
Cohesion: 0.06
Nodes (76): LEGAL_ANALYSIS_MAX_OUTPUT_TOKENS, mysqlConsultationRepository, getOrganizationInstitutionalProfile(), AUTHORITY_LABEL, buildApplicabilityCaveat(), buildConsultationAnswer(), classifyEvidenceSufficiency(), computeAnswerId() (+68 more)

### Community 155 - "DocumentIngestionLauncher.tsx"
Cohesion: 0.11
Nodes (24): DocumentIngestionLauncherProps, IngestionAuditSummary(), StagingSummary, Stat(), IngestionErrorState(), IngestionErrorStateProps, IngestionWarning, IngestionWarningsPanel() (+16 more)
...
Cohesion: 0.04
Nodes (62): _appendEvent(), auditPolicy(), computeComplianceScore(), createPolicy(), enforcePolicy(), getActivePolicies(), GovernanceAction, GovernanceAuditTrail (+54 more)
...
### Community 164 - "tenantIsolationAuditService.ts"
Cohesion: 0.09
...
Cohesion: 0.13
Nodes (24): listOperationalEvents(), listOperationalTimeline(), listOperationRecords(), computeIndicators(), CONCLUDED_CONTRACT, CONCLUDED_PROCESS, ConsolidatedInput, MonitoringRow (+16 more)
...
Cohesion: 0.10
Nodes (47): code(), getDomainWorkspace(), insertDomainWorkspace(), upsertBusinessDomain(), upsertKernelService(), upsertModuleDependency(), AssembledProcess, assembleProcess() (+39 more)
...
### Community 219 - "operationalFeedbackService.ts"
Cohesion: 0.15
...
Cohesion: 0.12
Nodes (27): DocumentApprovalPanel(), FileDropzone(), FileDropzoneProps, InlineError(), isPreconditionFailed(), POLL_STATUSES, StartFileInput, StartInput (+19 more)
...
### Community 404 - "workspaceTaskService.ts"
Cohesion: 0.22
...
### Community 459 - "workloadIntelligenceService.ts"
Cohesion: 0.12
...
Cohesion: 0.06
Nodes (50): featureFlags, tenantFeatureFlags, AppEnv, compareDirectContractShadow(), DirectContractDocType, normalize(), REQUIRED_SIGNALS, sha256Hex() (+42 more)
...
### Community 666 - "user-management-rbac.test.ts"
Cohesion: 0.15
...
### Community 670 - "tokenBudgetService.ts"
Cohesion: 0.18
...
### Community 671 - "status.ts"
Cohesion: 0.26
Nodes (10): IngestionSessionProgress(), IngestionStatusBadge(), derivePhase(), IngestionPhase, IngestionSessionStatus, IngestionTone, INSTITUTIONAL_COPY, PHASE_META (+2 more)
...
Cohesion: 0.16
Nodes (11): Step1LegalFramework(), Step2ContractData(), CNPJData, CNPJValidation, Props, Step3Supplier(), STEPS, WizardStepper() (+3 more)
...
### Community 684 - "aiProviderAbstractionService.ts"
Cohesion: 0.18
...
Cohesion: 0.02
Nodes (147): emailOutbox, InsertUser, InstitutionalInvitation, institutionalInvitations, Organization, organizations, PasswordResetToken, passwordResetTokens (+139 more)

### Community 690 - "OpinionHistory.tsx"
Cohesion: 0.22
...
Cohesion: 0.04
Nodes (105): generatedDocumentsTable, intelligentItemsTable, itemCatmatMatchesTable, itemHistoryTable, itemRecommendationsTable, itemRisksTable, processTimelineTable, listContractWorkspaces() (+97 more)

### Community 697 - "institutionalQuery.ts"
Cohesion: 0.27
...
### Community 708 - "contractValidationExample.ts"
Cohesion: 0.36
...
Cohesion: 0.08
Nodes (15): ComponentsShowcase(), fromDbDatetime(), recordValues(), Row, rowToRecord(), rowToSource(), SrcRow, toDbDatetime() (+7 more)
...
### Community 729 - "rateLimiter.ts"
Cohesion: 0.28
Nodes (5): RATE_LIMITS, RateLimitEntry, rateLimitStore, resetRateLimit(), resolveRateLimitIdentifier()
...
### Community 737 - "listDocumentReferences"
Cohesion: 0.36
...
### Community 745 - "directContractPackage.ts"
Cohesion: 0.47
...
Cohesion: 0.53
Nodes (4): canPromoteSession(), isPromotableType(), PROMOTABLE_IMPORT_TYPES, PromotableSessionView
...
### Community 831 - "react"
Cohesion: 0.07
Nodes (24): COPILOT_META, CopilotComparisonPanel(), metaFor(), ActionList(), CopilotPolicyManager(), COPILOTS, RISK_OPTIONS, RiskThreshold (+16 more)
...
## Knowledge Gaps
- **6382 isolated node(s):** `OperationsHomeShellRoute`, `ProcessosShellRoute`, `DirectProcurementShellRoute`, `ParecerJuridicoShellRoute`, `ContratosWorkspaceShellRoute` (+6377 more)
...
- **Why does `getDb()` connect `getDb` to `User`, `schema.ts`, `documentService.ts`, `procurementProcessService.ts`, `institutionalRequests.ts`, `sprint25-hardening.test.ts`, `legalOpinionWorkspaceService.ts`, `sprint50-workspace.test.ts`, `workspaceRiskService.ts`, `workspaceTaskService.ts`, `contractService.ts`, `db/catmatGovernance.ts`, `emailDispatcher.ts`, `institutionalConsultationService.ts`, `aiUsageTracker.ts`, `tasks.ts`, `db/businessDomains.ts`, `knowledgeGraph.ts`, `documentsRouter.ts`, `observabilityService.ts`, `ai.ts`, `invitationService.ts`, `documentEngineService.ts`, `procurement.ts`, `sprint49-copilots.test.ts`, `ontologyRouter.ts`, `documentPromotionService.ts`, `legalOpinions.ts`, `moduleLicensingService.ts`, `institutionalRetrievalService.ts`, `directProcurement.ts`, `organizations.ts`, `departmentOperationService.ts`, `processItems.ts`, `sprint501-business-domains.test.ts`, `_core/index.ts`, `contracts.ts`, `featureFlagAdminService.ts`, `institutionalConsultations.ts`, `importQueueService.ts`, `sprint5op-department-operation.test.ts`, `connection.ts`, `listDocumentReferences`, `systemRouter.ts`, `productionMonitoringService.ts`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `bcrypt`, `dotenv`, `class-variance-authority`, `clsx`, `jspdf`, `next-themes`, `pdf-parse`, `cmdk`, `@radix-ui/react-accordion`, `package.json`, `@radix-ui/react-alert-dialog`, `@radix-ui/react-aspect-ratio`, `@radix-ui/react-collapsible`, `@radix-ui/react-context-menu`, `@radix-ui/react-dialog`, `stripe`, `tailwind-merge`, `@radix-ui/react-select`, `nanoid`, `sonner`, `framer-motion`, `@dnd-kit/core`, `documentsRouter.ts`, `@tiptap/starter-kit`, `superjson`, `@radix-ui/react-menubar`, `@trpc/server`, `@radix-ui/react-progress`, `diff-match-patch`, `@trpc/react-query`, `react-dom`, `@radix-ui/react-tooltip`, `@tiptap/react`, `@tanstack/react-query`, `wouter`, `@radix-ui/react-toggle-group`, `resend`, `react`, `busboy`, `@dnd-kit/sortable`, `drizzle-orm`, `@radix-ui/react-tabs`, `@radix-ui/react-radio-group`, `jose`, `_core/index.ts`, `tailwindcss-animate`, `mysql2`, `openai`, `xlsx`, `@radix-ui/react-navigation-menu`, `react-day-picker`, `react-hook-form`, `@tiptap/extension-placeholder`, `use-debounce`, `vaul`, `@aws-sdk/s3-request-presigner`, `@aws-sdk/client-s3`, `helmet`, `axios`, `date-fns`?**
