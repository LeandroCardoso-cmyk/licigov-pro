...
## Corpus Check
- 2170 files · ~2,733,261 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 15461 nodes · 31523 edges · 882 communities (759 shown, 123 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 114 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `28d56f8a`
...
## Communities (882 total, 123 thin omitted)
...
### Community 1 - "App.tsx"
Cohesion: 0.02
Nodes (93): AdminOrganizacoesShellRoute, App(), AuthenticatedRoute(), ContratosWorkspaceShellRoute, DirectProcurementShellRoute, OperationsHomeShellRoute, ParecerJuridicoShellRoute, ProcessosShellRoute (+85 more)
...
Cohesion: 0.05
Nodes (77): AIExecutionPolicy, AITaskId, AIExecutionContext, CognitiveGroundingUsage, CognitiveOutcome, CognitiveRequest, contextReplayHash(), createExecutionContext() (+69 more)
...
### Community 7 - "cn"
Cohesion: 0.01
Nodes (270): AIChatBox(), AIChatBoxProps, Message, ActionList(), CopilotPolicyManager(), COPILOTS, RISK_OPTIONS, RiskThreshold (+262 more)
...
Cohesion: 0.02
Nodes (198): AdminStatsGrid(), Props, StatCardProps, AdminUser, Props, ChecklistPreviewDialogWrapper(), Props, Props (+190 more)

### Community 10 - "ExplainabilityPanel.tsx"
Cohesion: 0.15
...
### Community 13 - "xlsxParser.ts"
Cohesion: 0.09
Nodes (26): ExtractionSummary, ImportError, ImportWarning, BaseParser, noopObservability, ParseOptions, ParserCapabilities, ParserCapabilityStatus (+18 more)
...
Cohesion: 0.06
Nodes (52): advanceWorkflow(), assignReviewer(), balanceWorkload(), canAdvance(), currentStageAssignees(), delegateApproval(), emergencyApprove(), EscalationRule (+44 more)
...
Cohesion: 0.07
Nodes (43): adminProcedure, ORG_ROLE_RANK, protectedProcedure, requireUser, resolveTenant, router, t, tenantProcedure (+35 more)
...
Cohesion: 0.11
Nodes (27): CommentsSection(), DocActionsProps, DocTabContent(), formatDate(), Props, DocumentApprovalPanel(), Props, StageAssignmentPanel() (+19 more)
...
Cohesion: 0.07
Nodes (34): DocumentReviewDecisionRow, documentReviewDecisionsTable, InsertDocumentReviewDecision, OrgRole, DocumentReviewAction, getDocumentReviewDecisions(), insertDocumentReviewDecision(), WorkflowAlteradoPayload (+26 more)
...
Cohesion: 0.04
Nodes (117): generatedDocumentEditsTable, generatedDocumentsTable, intelligentItemsTable, itemCatmatMatchesTable, itemHistoryTable, itemRecommendationsTable, itemRisksTable, processTimelineTable (+109 more)
...
Cohesion: 0.02
Nodes (132): Props, TemplateInstructionsDialog(), AiAssistantPanel(), Props, Result, Tab, TAB_CONFIG, AuditTimeline() (+124 more)
...
### Community 62 - "copilotReasoningService.ts"
Cohesion: 0.14
...
Cohesion: 0.08
Nodes (36): applyDraftContentMutationTx(), DraftEditOperation, getGeneratedDocumentByKind(), approveDocument(), buildDFDDraft(), createGeneratedDocument(), defaultPresencialJustification(), DocumentKind (+28 more)
...
### Community 65 - "CollaborationTimeline.tsx"
Cohesion: 0.47
...
### Community 74 - "catalogSearchEngine.ts"
Cohesion: 0.16
...
Cohesion: 0.10
Nodes (22): operationalEventsTable, operationalMilestonesTable, operationalSettingsTable, operationalTimelineTable, operationRecordsTable, publicationRecordsTable, MilestoneType, OperationalMilestone (+14 more)

### Community 90 - "sprint5op-department-operation.test.ts"
Cohesion: 0.15
Nodes (29): countOperationalTimeline(), insertOperationalEvent(), insertOperationalMilestone(), insertOperationalTimelineEntry(), insertOperationRecord(), upsertPublicationRecord(), createExpirationEvents(), createOperationalEvent() (+21 more)
...
Cohesion: 0.06
Nodes (44): importItemCorrections, importPromotions, importSessions, importStagingItems, priceResearchItemsTable, priceResearchTable, computeEffectiveContent(), CORRECTABLE_FIELDS (+36 more)
...
Cohesion: 0.04
Nodes (99): Props, DOCUMENT_TYPES, DocumentUploadDialog(), Props, UploadData, AIHistoryTable(), AIRecord, OPERATION_LABELS (+91 more)
...
Cohesion: 0.07
Nodes (62): officialDocumentsTable, officialDocumentTimelineTable, toDbDatetime(), countDocumentTimeline(), countVersions(), Db, getLatestByLineage(), getOfficialDocument() (+54 more)
...
Cohesion: 0.08
Nodes (32): mockFallbackAllowed(), ProviderName, GeminiProvider, mapFinishReason(), REQUEST_OPTIONS, SAFETY_SETTINGS, shouldDisableThinking(), THINKING_DISABLE_COMPATIBLE_MODELS (+24 more)
...
Cohesion: 0.07
Nodes (55): AI_CONFIG, environmentDiagnostic(), AI_EXECUTION_POLICIES, ALL_AI_TASKS, getExecutionPolicy(), ALL_PROVIDER_NAMES, isProviderImplemented(), checkEnv() (+47 more)
...
Cohesion: 0.06
Nodes (34): Process, aiAssistantRouter, authRouter, documentsRouter, ingestionRouter, processesRouter, procurementProcessRouter, makeContext() (+26 more)
...
Cohesion: 0.08
Nodes (46): Citation, CONTEXT_PACKAGE_CONTRACT, ContextDocument, ContextExplainabilityEntry, CreateContextPackageParams, RetrievedPassage, inferTenantLocation(), InstitutionalContext (+38 more)
...
Cohesion: 0.06
Nodes (46): idempotencyKeys, getLatestOfficialPromotion(), insertOfficialPromotion(), BUSINESS_DOMAIN, getOfficialPromotionSummary(), OfficialPromotionSummary, payloadHashOf(), PROMOTABLE_KINDS (+38 more)

### Community 134 - "tenantIsolationAuditService.ts"
Cohesion: 0.11
...
Cohesion: 0.09
Nodes (30): buildInstitutionalModel(), DocBlock, draftNotice(), flattenInline(), InlineRun, InstitutionalModel, metaLines(), pdfFont() (+22 more)
...
Cohesion: 0.13
Nodes (24): InsertOrganization, InsertOrganizationMember, addMemberToOrg(), countActiveAdmins(), createOrganization(), getAllMembersOfOrg(), getAllOrganizations(), getMembersOfOrg() (+16 more)

### Community 196 - "departmentOperationService.ts"
Cohesion: 0.12
Nodes (29): listOperationalEvents(), listOperationalTimeline(), listOperationRecords(), listDirectProcurementWorkspaces(), listPendingForDomain(), listLegalOpinionWorkspaces(), computeIndicators(), CONCLUDED_CONTRACT (+21 more)
...
### Community 209 - "operationalFeedbackService.ts"
Cohesion: 0.15
...
Cohesion: 0.06
Nodes (58): AdminUsersTable(), AddStepDialog(), EditStepDialog(), CommentsSectionProps, Props, FUNCTIONAL_ROLE_LABELS, MembersDialog(), MembersDialogProps (+50 more)
...
### Community 315 - "normativeTree.ts"
Cohesion: 0.23
...
Cohesion: 0.07
Nodes (24): User, SESSION_TTL_MS, TrpcContext, getSessionCookieOptions(), isSecureRequest(), LOCAL_HOSTS, isNonEmptyString(), sdk (+16 more)
...
### Community 654 - "ReviewWorkspacePage.tsx"
Cohesion: 0.25
...
### Community 657 - "normativeQueries.ts"
Cohesion: 0.27
...
### Community 660 - "user-management-rbac.test.ts"
Cohesion: 0.15
...
Cohesion: 0.07
Nodes (78): legalOpinionDraftsTable, legalOpinionHistoryTable, legalOpinionTemplatesTable, legalOpinionWorkspacesTable, countLegalOpinionHistory(), getLegalOpinionDraft(), getLegalOpinionDraftByWorkspace(), getLegalOpinionWorkspace() (+70 more)
...
### Community 672 - "sourceScopeRouter.ts"
Cohesion: 0.23
...
### Community 684 - "bootstrap.ts"
Cohesion: 0.08
Nodes (24): bootstrap(), ensureSchema(), log(), MIGRATIONS_FOLDER, runMigrations(), seedAdmin(), seedDefaultOrgMembership(), validateRequiredEnv() (+16 more)
...
Cohesion: 0.12
Nodes (25): flattenContent(), invokeLLM(), resolveSchema(), resolveToolChoice(), CatmatMatch, findCatmatMatches(), generateLegalOpinionWithValidation(), validateAllExistingOpinions() (+17 more)
...
Cohesion: 0.02
Nodes (150): activityLogs, emailOutbox, InsertUser, InstitutionalInvitation, institutionalInvitations, Organization, organizations, PasswordResetToken (+142 more)
...
### Community 696 - "downloadRouter.ts"
Cohesion: 0.23
...
### Community 719 - "bindingProjection.ts"
Cohesion: 0.15
...
### Community 726 - "TaskChartsSection.tsx"
Cohesion: 0.24
...
### Community 732 - "entityResolution.ts"
Cohesion: 0.18
...
### Community 739 - "aiProviderAbstractionService.ts"
Cohesion: 0.20
...
### Community 745 - "groundingExpansionService.ts"
Cohesion: 0.38
...
Cohesion: 0.05
Nodes (42): documentAttachments, OrganizationMember, organizationMembers, outboxDeadLetters, outboxEvents, detectPoisonEvents(), detectStuckEvents(), DlqMetrics (+34 more)
...
### Community 790 - "BemVindo"
Cohesion: 0.48
Nodes (4): BemVindo(), hasSeenWelcome(), markWelcomeSeen(), WELCOME_SEEN_KEY

### Community 791 - "knowledgeObservabilityService.ts"
Cohesion: 0.29
...
### Community 799 - "cnpjValidator.ts"
Cohesion: 0.90
Nodes (4): cleanCNPJ(), consultCNPJ(), formatCNPJ(), validateCNPJ()

### Community 800 - "Fase 16 - Conformidade LGPD"
Cohesion: 0.50
...
### Community 813 - "Fase 14 - Sistema de Comentários"
Cohesion: 0.67
...
- **Why does `getDb()` connect `getDb` to `invitationsRouter.ts`, `schema.ts`, `documentService.ts`, `documentPromotionService.ts`, `directContractsRouter.ts`, `institutionalRequests.ts`, `sprint25-hardening.test.ts`, `directContractAuditReport.ts`, `db/workspace.ts`, `ingestionRouter.ts`, `contractService.ts`, `db/catmatGovernance.ts`, `institutionalConsultations.ts`, `workspaceDecisionService.ts`, `institutionalConsultationService.ts`, `legalOpinionWorkspaceService.ts`, `sprint50-workspace.test.ts`, `aiUsageTracker.ts`, `knowledgeGraph.ts`, `embeddings.ts`, `documentsRouter.ts`, `documentWorkflowService.ts`, `procurement.ts`, `connection.ts`, `_core/index.ts`, `operationRecordRouter.ts`, `sprint49-copilots.test.ts`, `officialDocumentPromotions.ts`, `tasks.ts`, `procurementProcessService.ts`, `directContractDocuments.ts`, `institutionalRetrievalService.ts`, `directProcurement.ts`, `organizations.ts`, `departmentOperationService.ts`, `rc421-production-readiness.test.ts`, `sprint501-business-domains.test.ts`, `contracts.ts`, `featureFlagAdminService.ts`, `departmentOperation.ts`, `sprint5op-department-operation.test.ts`, `importPromotionService.ts`, `documentEngineService.ts`, `legalOpinions.ts`, `emailDispatcher.ts`, `contractsRouter.ts`, `aiResilience.ts`, `productionMonitoringService.ts`, `importQueueService.ts`, `ontologyRouter.ts`, `observabilityService.ts`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `@radix-ui/react-aspect-ratio`, `@radix-ui/react-select`, `class-variance-authority`, `@aws-sdk/client-s3`, `cn`, `bcrypt`, `framer-motion`, `@radix-ui/react-toggle-group`, `sonner`, `resend`, `@tanstack/react-query`, `@trpc/react-query`, `package.json`, `stripe`, `tailwind-merge`, `nanoid`, `documentsRouter.ts`, `@tiptap/starter-kit`, `superjson`, `@radix-ui/react-menubar`, `@trpc/server`, `@radix-ui/react-progress`, `diff-match-patch`, `react-dom`, `@tiptap/react`, `wouter`, `_core/index.ts`, `@dnd-kit/sortable`, `drizzle-orm`, `@radix-ui/react-tabs`, `@radix-ui/react-radio-group`, `jose`, `tailwindcss-animate`, `mysql2`, `openai`, `xlsx`, `axios`, `@radix-ui/react-navigation-menu`, `busboy`, `date-fns`, `@dnd-kit/core`, `clsx`, `react-day-picker`, `react-hook-form`, `cmdk`, `@tiptap/extension-placeholder`, `next-themes`, `@radix-ui/react-tooltip`, `use-debounce`, `dotenv`, `vaul`, `jspdf`, `@aws-sdk/s3-request-presigner`, `pdf-parse`, `@radix-ui/react-accordion`, `@radix-ui/react-alert-dialog`, `helmet`, `@radix-ui/react-collapsible`, `@radix-ui/react-context-menu`, `@radix-ui/react-dialog`?**
...
- **Should `schema.ts` be split into smaller, more focused modules?**
  _Cohesion score 0.005139556776836374 - nodes in this community are weakly interconnected._
- **Should `App.tsx` be split into smaller, more focused modules?**
  _Cohesion score 0.019351570415400202 - nodes in this community are weakly interconnected._