...
## Corpus Check
- 1786 files · ~2,431,596 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 12662 nodes · 24674 edges · 821 communities (670 shown, 151 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 60 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `042112e1`
...
## Communities (821 total, 151 thin omitted)

### Community 0 - "schema.ts"
Cohesion: 0.01
Nodes (365): actionSafetyLogsTable, ActivityLog, agentExecutionsTable, AIExecutionAuditRow, aiExecutionAuditsTable, AIOrchestrationRow, aiOrchestrationsTable, AIPromptVersionRow (+357 more)

### Community 1 - "card.tsx"
Cohesion: 0.02
Nodes (141): AdminStatsGrid(), Props, StatCardProps, AdminUser, Props, AIChartsSection(), COLORS, LineItem (+133 more)

### Community 2 - "trpc.ts"
Cohesion: 0.03
Nodes (124): documentAttachments, documents, documentTimeline, outboxDeadLetters, outboxEvents, ComentarioAdicionado, ComentarioAdicionadoPayload, DOCUMENT_EVENT_TYPES (+116 more)

### Community 3 - "getDb"
Cohesion: 0.02
Nodes (167): activityLogs, auditLogs, catmatSuggestions, comments, companyDocuments, contractRenewals, DocumentSettings, documentTemplates (+159 more)
...
Cohesion: 0.05
Nodes (81): Props, Props, Props, CandidateDecisionModalProps, CandidateInfo, CatmatSuggestionsModalProps, AddStepDialog(), Props (+73 more)
...
### Community 7 - "cn"
Cohesion: 0.04
Nodes (78): AlertDialogOverlay(), ButtonGroup(), ButtonGroupSeparator(), ButtonGroupText(), buttonGroupVariants, CardAction(), ContextMenu(), ContextMenuCheckboxItem() (+70 more)
...
Cohesion: 0.04
Nodes (67): computeChecksum(), TRClause, TRSection, exportHistory, exportRouter, CatalogEntryType, normalizeCatalogEntry(), CacheService (+59 more)
...
Cohesion: 0.05
Nodes (95): buildRecommendation(), clamp01(), ClauseCompatibilityResult, ClauseHierarchyNode, ClauseItemInput, ClauseItemLink, ClauseRecommendation, ClauseRecommendationContext (+87 more)
...
Cohesion: 0.02
Nodes (98): ChecklistPreviewDialogWrapper(), Props, TemplateInstructionsDialog(), Props, TemplatePreviewDialogWrapper(), ChecklistPreviewDialog(), TemplatePreviewDialog(), BusinessDomainCode (+90 more)
...
Cohesion: 0.03
Nodes (105): directContractAuditLogs, DirectContractChecklistProgress, directContractDocuments, directContractLegalArticles, directContractQuotations, directContracts, InsertDirectContract, InsertDirectContractAuditLog (+97 more)

### Community 56 - "TaskDetailModal.tsx"
Cohesion: 0.08
Nodes (35): AiAssistantPanel(), DocActionsProps, DocTabContent(), formatDate(), Props, DocStatus, DocumentApprovalPanel(), Props (+27 more)
...
Cohesion: 0.12
Nodes (28): getEdgesForNodes(), searchKnowledgeNodes(), contextDensity(), createWorkspaceContext(), WorkspaceContext, WorkspaceContextDocument, WorkspaceContextEvidence, clearMemory() (+20 more)
...
Cohesion: 0.12
Nodes (16): Arquitetura da experiência (RC-X.1), As 13 Cognitive Tasks, Ativação cognitiva (RC-4.1), Cognitive Architecture — Fundação Cognitiva (RC-4.0), Componentes da fundação, Conhecimento institucional (RC-4.3), Contrato cognitivo definitivo (RC-4.0.1), Estrutura do conhecimento jurídico (RC-4.4) (+8 more)
...
Cohesion: 0.11
Nodes (31): listContractWorkspaces(), listOperationalEvents(), listOperationalTimeline(), listOperationRecords(), listDirectProcurementWorkspaces(), listPendingForDomain(), listLegalOpinionWorkspaces(), listProcesses() (+23 more)
...
Cohesion: 0.08
Nodes (26): 1. tRPC API Layer, 2. Domain Layer (DDD Aggregates), 3. Infrastructure Services, Componentes Principais, ConcurrencyService, Decisões de Escalabilidade, Deploy e Infraestrutura, DocumentoLicitatorio (+18 more)
...
Cohesion: 0.15
Nodes (20): contracts, NotificationPayload, notifyOwner(), validate(), contractsRouter, AmendmentData, ApostilleData, ContractData (+12 more)
...
Cohesion: 0.06
Nodes (48): documentDrafts, calculateBackoffMs(), isRetryable(), RetryPolicy, RetryPolicyName, BaseTenantRepository, DocumentRepository, DocumentRow (+40 more)
...
Cohesion: 0.05
Nodes (53): Accordion(), AccordionContent(), AccordionItem(), AccordionTrigger(), AspectRatio(), Breadcrumb(), BreadcrumbEllipsis(), BreadcrumbItem() (+45 more)
...
Cohesion: 0.04
Nodes (55): AuditTimeline(), ChecklistTab(), ContractDocumentsTab(), Props, ContractHistoryTab(), Props, brl(), ContractOverviewTab() (+47 more)
...
Cohesion: 0.10
Nodes (25): detectParserType(), ImportSessionStatus, ImportType, cancelImportSession(), createImportSession(), CreateImportSessionParams, FileValidationResult, getImportSession() (+17 more)
...
Cohesion: 0.06
Nodes (43): AuthenticatedRoute(), ActivityFiltersCard(), ACTION_COLORS, ACTION_LABELS, Activity, ActivityLogCard(), Props, CommentsSection() (+35 more)
...
Cohesion: 0.06
Nodes (63): ComponentsShowcase(), aggregateConfidence(), buildFieldConfidence(), ConfidenceLevel, ConfidenceMetadata, EMPTY_CONFIDENCE, ExtractionError, ExtractionErrorCode (+55 more)

### Community 143 - "promptGovernance.ts"
Cohesion: 0.07
Nodes (39): DashboardLayoutContent(), DashboardLayoutContentProps, menuItems, DashboardLayoutSkeleton(), Avatar(), AvatarFallback(), AvatarImage(), Sidebar() (+31 more)
...
Cohesion: 0.03
Nodes (43): App(), BackToDashboard(), BackToDashboardProps, BreadcrumbItem, Breadcrumbs(), BreadcrumbsProps, Contract, ContractCard() (+35 more)
...
Cohesion: 0.15
Nodes (26): AdminUsersTable(), CommentsSectionProps, SemanticCandidateItem, SemanticCandidatePanelProps, sourceLabels, Props, FUNCTIONAL_ROLE_LABELS, MembersDialogProps (+18 more)
...
Cohesion: 0.09
Nodes (25): Props, Result, Tab, TAB_CONFIG, ItemTRDetailSheet(), ItemTRDetailSheetProps, ReviewDetailPanel(), ReviewQueueItem() (+17 more)
...
Cohesion: 0.11
Nodes (17): CacheMetricsWidget(), CacheMetricsWidgetProps, IngestionStatusWidget(), IngestionStatusWidgetProps, statusBadge, ProductionReadinessPageProps, HealthCheck, statusColors (+9 more)
...
Cohesion: 0.11
Nodes (17): ModuleCard(), DropdownMenu(), DropdownMenuCheckboxItem(), DropdownMenuContent(), DropdownMenuItem(), DropdownMenuLabel(), DropdownMenuRadioItem(), DropdownMenuSeparator() (+9 more)
...
Cohesion: 0.09
Nodes (24): ContractsHome(), NewContractWizard(), NewContractWizardProps, Origin, COPILOT_META, CopilotComparisonPanel(), metaFor(), ActionList() (+16 more)
...
Cohesion: 0.20
Nodes (9): AIChatBox(), AIChatBoxProps, Message, NotificationBell(), Popover(), PopoverContent(), PopoverTrigger(), ScrollArea() (+1 more)
...
Cohesion: 0.16
Nodes (10): Step1LegalFramework(), Step2ContractData(), CNPJData, CNPJValidation, Props, Step3Supplier(), STEPS, WizardStepper() (+2 more)
...
Cohesion: 0.22
Nodes (9): Componentes, Explainability (Part 12), Extensibilidade (Part 10), Garantias, Garantias por teste (`rcx1-institutional-experience-framework.test.ts`, ORG 12900), Institutional Experience Framework (RC-X.1), Licenciamento & Multi-Tenant (Parts 8 e 9), O que é (+1 more)
...
### Community 733 - "ResponsePanel.tsx"
Cohesion: 0.33
...
### Community 765 - "Fase 6 - Aplicar Personalização e Downloads"
Cohesion: 0.67
...
## Knowledge Gaps
- **5309 isolated node(s):** `UseAuthOptions`, `AIChatBoxProps`, `Props`, `Tab`, `Result` (+5304 more)
...
- **Why does `getDb()` connect `getDb` to `trpc.ts`, `vectorIndexService.ts`, `institutionalRequests.ts`, `clauseIntelligence.ts`, `sprint25-hardening.test.ts`, `ComponentShowcase.tsx`, `sprint50-workspace.test.ts`, `xlsxParser.ts`, `priceResearch.ts`, `interoperabilityObservabilityService.ts`, `embeddings.ts`, `react`, `DocumentsWorkspace.tsx`, `knowledgeGraph.ts`, `fileIngestionService.ts`, `documentsRouter.ts`, `legalOpinions.ts`, `platforms`, `sprint33-collaboration-interop.test.ts`, `CopilotType`, `cnpjValidator.ts`, `directContractsRouter.ts`, `tasks.ts`, `organizationsRouter.ts`, `institutionalRetrievalService.ts`, `VersionHistoryDialog.tsx`, `communicationLayer.ts`, `legalReasoningEngine.ts`, `catalogSearchEngine.ts`, `contracts.ts`, `aiUsageTracker.ts`, `procurement.ts`, `moduleLicensingService.ts`, `sprint51-procurement.test.ts`, `dependencies`, `featureFlagService.ts`?**
...
- **What connects `UseAuthOptions`, `AIChatBoxProps`, `Props` to the rest of the system?**
  _5316 weakly-connected nodes found - possible documentation gaps or missing edges._
...
- **Should `trpc.ts` be split into smaller, more focused modules?**
  _Cohesion score 0.030149158997143762 - nodes in this community are weakly interconnected._