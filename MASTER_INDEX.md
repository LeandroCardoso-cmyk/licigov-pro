...
> Versão: 0.20.0 | Branch: claude/rc-4.9 | Atualizado: 2026-07-17
...
| 📜🏛️ Corpus Oficial (Federal+PR+Moreira Sales) | [docs/architecture/OFFICIAL_KNOWLEDGE_CORPUS.md](docs/architecture/OFFICIAL_KNOWLEDGE_CORPUS.md) | **Primeiro corpus OFICIAL com texto real verbatim (Lei 14.133, Decreto 11.462, IN SEGES 65, LC 123, Manual TCU, TCE-PR) via pipeline existente; hierarquia Federal→Estado→Município; classificação, resolução por tenant, quality gates (perfil oficial) — SEM RAG/IA/chat; multi-tenant, replay-safe (RC-4.9)** |
