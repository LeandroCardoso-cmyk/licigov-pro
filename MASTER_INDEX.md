...
> Versão: 0.9.0 | Branch: claude/rebuild-licigov-pro-bFyTO | Atualizado: 2026-07-16
...
| **🧠 Fundação Cognitiva** | [docs/architecture/COGNITIVE_ARCHITECTURE.md](docs/architecture/COGNITIVE_ARCHITECTURE.md) | **AIExecutionEngine como cérebro institucional: Cognitive Tasks, Cognitive Pipeline, Cognitive Response, Prompt Builders tipados, Explainability obrigatória (RC-4.0)** |
