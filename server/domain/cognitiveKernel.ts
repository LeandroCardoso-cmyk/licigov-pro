...
export const KERNEL_SERVICES: Record<KernelServiceId, KernelService> = {
  ...
  official_document_lifecycle: { id: "official_document_lifecycle", name: "Official Document Lifecycle Service", category: "document", description: "Ciclo de vida do documento oficial: versionar, timeline, hash, persistir metadados, Storage Service e Signed URL. Document Engine apenas gera." },
