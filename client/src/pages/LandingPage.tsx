  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative py-16 md:py-24 overflow-hidden">
        {/* Background com imagem de prédios governamentais */}
      ...
      <section className="bg-gradient-to-br from-gray-50 to-white py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {/* Plano Básico */}
            <Card className="border-2 hover:border-blue-300 hover:shadow-xl transition-all h-full flex flex-col">
            ...
            <Card className="border-2 border-slate-500 hover:border-slate-600 hover:shadow-2xl transition-all relative h-full flex flex-col">
              ...
              <CardContent className="p-8 flex flex-col h-full">
                ...
                <ul className="space-y-3 mb-8 flex-grow">
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-700 text-sm">Colaboração em Equipe</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
            ...
            <Card className="border-2 hover:border-blue-300 hover:shadow-xl transition-all h-full flex flex-col">
              <CardContent className="p-8 flex flex-col h-full">
                ...
                <ul className="space-y-3 mb-8 flex-grow">
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-700 text-sm">Gestão do Departamento</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
